...
public class CollectionMapper {
    ...
    static class 1 implements OnMapperCompleteListener {
        ...
        1(Mutable mutable, Mutable mutable2, OnMapperCompleteListener onMapperCompleteListener) {
    ...
    static class 2 implements OnMapValueCompleteListener {
        final /* synthetic */ Collection val$collection;
        final /* synthetic */ OnMapperCompleteListener val$jobCompleteListener;
        final /* synthetic */ Object val$key;

        2(Collection collection, Object obj, OnMapperCompleteListener onMapperCompleteListener) {
    ...
    public static <T> void iterate(Collection<T> collection, ValueMapper valueMapper, OnMapperCompleteListener onMapperCompleteListener) {
        ...
        OnMapperCompleteListener jobCompleteListener = new 1(didReturnError, pendingJobCount, onMapperCompleteListener);
        ...
        for (T key : keys) {
            ...
            OnMapValueCompleteListener onMapValueCompleteListener = new 2(collection, key, jobCompleteListener);
