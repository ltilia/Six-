...
public class AttributionIdentifiers {
    ...
    private static AttributionIdentifiers getAndroidIdViaReflection(Context context) {
        try {
            ...
            Method isLimitAdTrackingEnabled = Utility.getMethodQuietly(advertisingInfo.getClass(), GpsHelper.IS_LIMIT_AD_TRACKING_ENABLED_KEY, new Class[CONNECTION_RESULT_SUCCESS]);
