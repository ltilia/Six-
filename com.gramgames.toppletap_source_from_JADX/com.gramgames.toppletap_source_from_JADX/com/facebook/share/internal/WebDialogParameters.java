...
public class WebDialogParameters {
    public static Bundle create(AppGroupCreationContent appGroupCreationContent) {
        ...
        Utility.putNonEmptyString(webParams, UnityAdsConstants.UNITY_ADS_ZONE_NAME_KEY, appGroupCreationContent.getName());
    ...
    public static Bundle create(GameRequestContent gameRequestContent) {
        ...
        Utility.putNonEmptyString(webParams, UnityAdsConstants.UNITY_ADS_JSON_DATA_ROOTKEY, gameRequestContent.getData());
    ...
    public static Bundle createForFeed(ShareLinkContent shareLinkContent) {
        Bundle webParams = new Bundle();
        Utility.putNonEmptyString(webParams, UnityAdsConstants.UNITY_ADS_ZONE_NAME_KEY, shareLinkContent.getContentTitle());
        ...
        Utility.putNonEmptyString(webParams, UnityAdsConstants.UNITY_ADS_REWARD_PICTURE_KEY, Utility.getUriString(shareLinkContent.getImageUrl()));
    ...
    public static Bundle createForFeed(ShareFeedContent shareFeedContent) {
        ...
        Utility.putNonEmptyString(webParams, UnityAdsConstants.UNITY_ADS_REWARD_PICTURE_KEY, shareFeedContent.getPicture());
        Utility.putNonEmptyString(webParams, ShareConstants.FEED_SOURCE_PARAM, shareFeedContent.getMediaSource());
        Utility.putNonEmptyString(webParams, UnityAdsConstants.UNITY_ADS_ZONE_NAME_KEY, shareFeedContent.getLinkName());
