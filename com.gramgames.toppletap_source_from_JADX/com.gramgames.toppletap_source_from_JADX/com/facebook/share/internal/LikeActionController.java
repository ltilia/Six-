...
public class LikeActionController {
    ...
    class 10 implements CompletedListener {
        10() {
        }
    ...
    class 11 implements Callback {
        ...
        11(GetOGObjectIdRequestWrapper getOGObjectIdRequestWrapper, GetPageIdRequestWrapper getPageIdRequestWrapper, RequestCompletionCallback requestCompletionCallback) {
    ...
    static class 1 implements CreationCallback {
        final /* synthetic */ Intent val$data;
        final /* synthetic */ int val$requestCode;
        final /* synthetic */ int val$resultCode;

        1(int i, int i2, Intent intent) {
    ...
    static class 2 implements Runnable {
        ...
        2(LikeActionController likeActionController) {
    ...
    static class 3 implements CallbackManagerImpl.Callback {
        3() {
        }
    ...
    static class 4 implements Runnable {
        ...
        4(CreationCallback creationCallback, LikeActionController likeActionController, FacebookException facebookException) {
    ...
    static class 5 extends AccessTokenTracker {
        5() {
        }
    ...
    class 6 extends ResultProcessor {
        final /* synthetic */ Bundle val$analyticsParameters;

        6(FacebookCallback callback, Bundle bundle) {
    ...
    class 7 implements RequestCompletionCallback {
        final /* synthetic */ Bundle val$analyticsParameters;

        class 1 implements Callback {
            final /* synthetic */ PublishLikeRequestWrapper val$likeRequest;

            1(PublishLikeRequestWrapper publishLikeRequestWrapper) {
            ...
            public void onBatchCompleted(GraphRequestBatch batch) {
                ...
                LikeActionController.this.getAppEventsLogger().logSdkEvent(AnalyticsEvents.EVENT_LIKE_VIEW_DID_LIKE, null, 7.this.val$analyticsParameters);
        ...
        public void onComplete() {
            ...
            requestBatch.addCallback(new 1(likeRequest));
            requestBatch.executeAsync();
        }
    }

    class 8 implements Callback {
        final /* synthetic */ Bundle val$analyticsParameters;
        final /* synthetic */ PublishUnlikeRequestWrapper val$unlikeRequest;

        8(PublishUnlikeRequestWrapper publishUnlikeRequestWrapper, Bundle bundle) {
    ...
    class 9 implements RequestCompletionCallback {
        ...
        class 1 implements Callback {
            ...
            1(LikeRequestWrapper likeRequestWrapper, GetEngagementRequestWrapper getEngagementRequestWrapper) {
        ...
        public void onComplete() {
            ...
            switch (12.$SwitchMap$com$facebook$share$widget$LikeView$ObjectType[LikeActionController.this.objectType.ordinal()]) {
            ...
            requestBatch.addCallback(new 1(likeRequestWrapper, engagementRequest));
            requestBatch.executeAsync();
        }
    }
    ...
    private abstract class AbstractRequestWrapper implements RequestWrapper {
        ...
        class 1 implements GraphRequest.Callback {
            1() {
            }
    ...
    private class GetOGObjectIdRequestWrapper extends AbstractRequestWrapper {
        ...
        GetOGObjectIdRequestWrapper(String objectId, ObjectType objectType) {
            ...
            setRequest(new GraphRequest(AccessToken.getCurrentAccessToken(), BuildConfig.FLAVOR, objectIdRequestParams, HttpMethod.GET));
        }
        ...
        protected void processSuccess(GraphResponse response) {
            ...
            if (results != null) {
                ...
                if (ogObject != null) {
                    this.verifiedObjectId = ogObject.optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY);
                }
            }
        }
    }
    ...
    private class GetOGObjectLikesRequestWrapper extends AbstractRequestWrapper implements LikeRequestWrapper {
        ...
        protected void processSuccess(GraphResponse response) {
            JSONArray dataSet = Utility.tryGetJSONArrayFromResponse(response.getJSONObject(), UnityAdsConstants.UNITY_ADS_JSON_DATA_ROOTKEY);
            if (dataSet != null) {
                for (int i = 0; i < dataSet.length(); i++) {
                    ...
                    if (data != null) {
                        ...
                        if (!(appData == null || accessToken == null || !Utility.areObjectsEqual(accessToken.getApplicationId(), appData.optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY)))) {
                            this.unlikeToken = data.optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY);
                        }
                    }
                }
            }
    ...
    private class GetPageIdRequestWrapper extends AbstractRequestWrapper {
        ...
        GetPageIdRequestWrapper(String objectId, ObjectType objectType) {
            ...
            pageIdRequestParams.putString(GraphRequest.FIELDS_PARAM, UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY);
            pageIdRequestParams.putString("ids", objectId);
            setRequest(new GraphRequest(AccessToken.getCurrentAccessToken(), BuildConfig.FLAVOR, pageIdRequestParams, HttpMethod.GET));
        }

        protected void processSuccess(GraphResponse response) {
            JSONObject results = Utility.tryGetJSONObjectFromResponse(response.getJSONObject(), this.objectId);
            if (results != null) {
                this.verifiedObjectId = results.optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY);
    ...
    private class GetPageLikesRequestWrapper extends AbstractRequestWrapper implements LikeRequestWrapper {
        ...
        GetPageLikesRequestWrapper(String pageId) {
            ...
            this.pageId = pageId;
            Bundle requestParams = new Bundle();
            requestParams.putString(GraphRequest.FIELDS_PARAM, UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY);
    ...
    private class PublishLikeRequestWrapper extends AbstractRequestWrapper {
        ...
        protected void processSuccess(GraphResponse response) {
            this.unlikeToken = Utility.safeGetStringFromResponse(response.getJSONObject(), UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY);
        }
    ...
    public static boolean handleOnActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        getControllerForObjectId(objectIdForPendingController, ObjectType.UNKNOWN, new 1(requestCode, resultCode, data));
        return true;
    }
    ...
    private static void createControllerForObjectIdAndType(String objectId, ObjectType objectType, CreationCallback callback) {
        ...
        handler.post(new 2(controllerToRefresh));
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new 3());
                isInitialized = true;
            }
        }
    }
    ...
    private static void invokeCallbackWithController(CreationCallback callback, LikeActionController controller, FacebookException error) {
        if (callback != null) {
            handler.post(new 4(callback, controller, error));
        }
    }

    private static void registerAccessTokenTracker() {
        accessTokenTracker = new 5();
    }
    ...
    private static String getCacheKeyForObjectId(String objectId) {
        ...
        Object[] objArr = new Object[LIKE_ACTION_CONTROLLER_VERSION];
        objArr[0] = objectId;
        objArr[1] = Utility.coerceValueIfNullOrEmpty(accessTokenPortion, BuildConfig.FLAVOR);
    ...
    private ResultProcessor getResultProcessor(Bundle analyticsParameters) {
        return new 6(null, analyticsParameters);
    }
    ...
    private void publishLikeAsync(Bundle analyticsParameters) {
        ...
        fetchVerifiedObjectId(new 7(analyticsParameters));
    }
    ...
    private void publishUnlikeAsync(Bundle analyticsParameters) {
        ...
        requestBatch.addCallback(new 8(unlikeRequest, analyticsParameters));
        requestBatch.executeAsync();
    }
    ...
    private void refreshStatusViaService() {
        ...
        if (likeStatusClient.start()) {
            likeStatusClient.setCompletedListener(new 10());
        }
    }
    ...
    private void fetchVerifiedObjectId(RequestCompletionCallback completionHandler) {
        if (Utility.isNullOrEmpty(this.verifiedObjectId)) {
            ...
            requestBatch.addCallback(new 11(objectIdRequest, pageIdRequest, completionHandler));
            requestBatch.executeAsync();
