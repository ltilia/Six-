...
public class VideoUploader {
    ...
    static class 1 extends AccessTokenTracker {
        1() {
        }
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        class 2 implements Runnable {
            ...
            2(FacebookException facebookException, String str) {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            VideoUploader.getHandler().postDelayed(new 1(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
        ...
        protected void issueResponseOnMainThread(FacebookException error, String videoId) {
            VideoUploader.getHandler().post(new 2(error, videoId));
        }
    }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        ...
        static class 1 extends HashSet<Integer> {
            1() {
