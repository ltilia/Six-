...
public final class ShareApi {
    ...
    class 10 implements Callback {
        ...
        10(OnMapValueCompleteListener onMapValueCompleteListener) {
        ...
        public void onCompleted(GraphResponse response) {
            ...
            String stagedObjectId = data.optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY);
    ...
    class 11 implements OnMapperCompleteListener {
        final /* synthetic */ String val$ogType;
        final /* synthetic */ OnMapValueCompleteListener val$onOpenGraphObjectStagedListener;
        final /* synthetic */ Callback val$requestCallback;
        final /* synthetic */ JSONObject val$stagedObject;

        11(JSONObject jSONObject, String str, Callback callback, OnMapValueCompleteListener onMapValueCompleteListener) {
    ...
    class 12 implements Callback {
        final /* synthetic */ OnMapValueCompleteListener val$onPhotoStagedListener;
        final /* synthetic */ SharePhoto val$photo;

        12(OnMapValueCompleteListener onMapValueCompleteListener, SharePhoto sharePhoto) {
        ...
        public void onCompleted(GraphResponse response) {
            ...
            try {
                stagedObject.put(UnityAdsConstants.UNITY_ADS_FAILED_URL_URL_KEY, stagedImageUri);
    ...
    class 1 implements Callback {
        ...
        public void onCompleted(GraphResponse response) {
            JSONObject data = response.getJSONObject();
            ShareInternalUtility.invokeCallbackWithResults(this.val$callback, data == null ? null : data.optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY), response);
        }
    }

    class 2 implements OnMapperCompleteListener {
        final /* synthetic */ ShareOpenGraphAction val$action;
        final /* synthetic */ FacebookCallback val$callback;
        final /* synthetic */ Bundle val$parameters;
        final /* synthetic */ Callback val$requestCallback;

        2(Bundle bundle, ShareOpenGraphAction shareOpenGraphAction, Callback callback, FacebookCallback facebookCallback) {
    ...
    class 3 implements Callback {
        ...
        3(ArrayList arrayList, ArrayList arrayList2, Mutable mutable, FacebookCallback facebookCallback) {
        ...
        public void onCompleted(GraphResponse response) {
            ...
            if (!this.val$errorResponses.isEmpty()) {
                ...
                ShareInternalUtility.invokeCallbackWithResults(this.val$callback, ((JSONObject) this.val$results.get(0)).optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY), response);
            }
        }
    }
    ...
    class 4 implements Callback {
        ...
        4(FacebookCallback facebookCallback) {
            this.val$callback = facebookCallback;
        }
    ...
    class 5 implements Collection<Integer> {
        final /* synthetic */ ArrayList val$arrayList;
        final /* synthetic */ JSONArray val$stagedObject;

        class 1 implements Iterator<Integer> {
            final /* synthetic */ Mutable val$current;
            final /* synthetic */ int val$size;

            1(Mutable mutable, int i) {
        ...
        5(ArrayList arrayList, JSONArray jSONArray) {
            this.val$arrayList = arrayList;
            this.val$stagedObject = jSONArray;
        }

        public Iterator<Integer> keyIterator() {
            return new 1(new Mutable(Integer.valueOf(0)), this.val$arrayList.size());
        }
    ...
    class 6 implements OnMapperCompleteListener {
        final /* synthetic */ OnMapValueCompleteListener val$onArrayListStagedListener;
        final /* synthetic */ JSONArray val$stagedObject;

        6(OnMapValueCompleteListener onMapValueCompleteListener, JSONArray jSONArray) {
    ...
    class 7 implements ValueMapper {
        7() {
        }
    ...
    class 8 implements Collection<String> {
        final /* synthetic */ Bundle val$parameters;
    ...
    class 9 implements Collection<String> {
        final /* synthetic */ ShareOpenGraphObject val$object;
        final /* synthetic */ JSONObject val$stagedObject;

        9(ShareOpenGraphObject shareOpenGraphObject, JSONObject jSONObject) {
    ...
    private void shareOpenGraphContent(ShareOpenGraphContent openGraphContent, FacebookCallback<Result> callback) {
        Callback requestCallback = new 1(callback);
        ...
        stageOpenGraphAction(parameters, new 2(parameters, action, requestCallback, callback));
    }
    ...
    private void sharePhotoContent(SharePhotoContent photoContent, FacebookCallback<Result> callback) {
        ...
        Callback requestCallback = new 3(new ArrayList(), new ArrayList(), requestCount, callback);
        try {
    ...
    private void shareLinkContent(ShareLinkContent linkContent, FacebookCallback<Result> callback) {
        Callback requestCallback = new 4(callback);
        Bundle parameters = new Bundle();
        ...
        parameters.putString(UnityAdsConstants.UNITY_ADS_REWARD_PICTURE_KEY, Utility.getUriString(linkContent.getImageUrl()));
        parameters.putString(UnityAdsConstants.UNITY_ADS_ZONE_NAME_KEY, linkContent.getContentTitle());
    ...
    private void stageOpenGraphObject(ShareOpenGraphObject object, OnMapValueCompleteListener onOpenGraphObjectStagedListener) {
        ...
        JSONObject stagedObject = new JSONObject();
        stageCollectionValues(new 9(object, stagedObject), new 11(stagedObject, type, new 10(onOpenGraphObjectStagedListener), onOpenGraphObjectStagedListener));
    }
    ...
    private void stagePhoto(SharePhoto photo, OnMapValueCompleteListener onPhotoStagedListener) {
        ...
        Callback requestCallback = new 12(onPhotoStagedListener, photo);
        if (bitmap != null) {
