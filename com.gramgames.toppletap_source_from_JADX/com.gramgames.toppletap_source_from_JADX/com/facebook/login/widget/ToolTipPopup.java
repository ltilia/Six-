...
public class ToolTipPopup {
    ...
    class 1 implements OnScrollChangedListener {
        1() {
        }
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            registerObserver();
            this.mPopupContent.measure(MeasureSpec.makeMeasureSpec(decorWidth, Cue.TYPE_UNSET), MeasureSpec.makeMeasureSpec(decorHeight, Cue.TYPE_UNSET));
            ...
            if (this.mNuxDisplayTime > 0) {
                this.mPopupContent.postDelayed(new 2(), this.mNuxDisplayTime);
            }
            this.mPopupWindow.setTouchable(true);
            this.mPopupContent.setOnClickListener(new 3());
        }
    }
