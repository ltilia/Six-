...
public class LoginButton extends FacebookButtonBase {
    ...
    protected class LoginClickListener implements OnClickListener {
        ...
        protected void performLogout(Context context) {
            ...
            if (LoginButton.this.confirmLogout) {
                ...
                builder.setMessage(message).setCancelable(true).setPositiveButton(logout, new 1(loginManager)).setNegativeButton(cancel, null);
                builder.create().show();
                return;
            }
            loginManager.logOut();
    ...
    class 1 implements Runnable {
        ...
        class 1 implements Runnable {
            ...
            1(FetchedAppSettings fetchedAppSettings) {
        ...
        public void run() {
            LoginButton.this.getActivity().runOnUiThread(new 1(Utility.queryAppSettings(this.val$appId, false)));
        }
    }

    class 2 extends AccessTokenTracker {
        2() {
        }
    ...
    private void checkToolTipSettings() {
        switch (3.$SwitchMap$com$facebook$login$widget$LoginButton$ToolTipMode[this.toolTipMode.ordinal()]) {
            case Yytoken.TYPE_LEFT_BRACE /*1*/:
                FacebookSdk.getExecutor().execute(new 1(Utility.getMetadataApplicationId(getContext())));
