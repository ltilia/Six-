...
class GetTokenLoginMethodHandler extends LoginMethodHandler {
    ...
    class 1 implements CompletedListener {
    ...
    class 2 implements GraphMeRequestWithCacheCallback {
        final /* synthetic */ Request val$request;
        final /* synthetic */ Bundle val$result;

        2(Bundle bundle, Request request) {
        ...
        public void onSuccess(JSONObject userInfo) {
            try {
                this.val$result.putString(NativeProtocol.EXTRA_USER_ID, userInfo.getString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY));
    ...
    static class 3 implements Creator {
        3() {
        }
    ...
    boolean tryAuthorize(Request request) {
        ...
        this.getTokenClient.setCompletedListener(new 1(request));
        return true;
    }
    ...
    void complete(Request request, Bundle result) {
        ...
        if (userId == null || userId.isEmpty()) {
            this.loginClient.notifyBackgroundProcessingStart();
            Utility.getGraphMeRequestWithCacheAsync(result.getString(NativeProtocol.EXTRA_ACCESS_TOKEN), new 2(result, request));
            return;
        }
