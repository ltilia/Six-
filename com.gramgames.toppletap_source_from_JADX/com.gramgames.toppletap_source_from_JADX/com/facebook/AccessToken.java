...
public final class AccessToken implements Parcelable {
    ...
    static class 1 implements GraphMeRequestWithCacheCallback {
        final /* synthetic */ AccessTokenCreationCallback val$accessTokenCallback;
        final /* synthetic */ String val$applicationId;
        final /* synthetic */ Bundle val$extras;

        1(Bundle bundle, AccessTokenCreationCallback accessTokenCreationCallback, String str) {
        ...
        public void onSuccess(JSONObject userInfo) {
            try {
                this.val$extras.putString(AccessToken.USER_ID_KEY, userInfo.getString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY));
    ...
    static class 2 implements Creator {
        2() {
        }
    ...
    static {
        MAX_DATE = new Date(PtsTimestampAdjuster.DO_NOT_OFFSET);
    ...
    public static void createFromNativeLinkingIntent(Intent intent, String applicationId, AccessTokenCreationCallback accessTokenCallback) {
        ...
        if (userId == null || userId.isEmpty()) {
            Utility.getGraphMeRequestWithCacheAsync(accessToken, new 1(extras, accessTokenCallback, applicationId));
        } else {
