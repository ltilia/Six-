...
public final class FacebookSdk {
    ...
    static class 2 implements Callable<File> {
        2() {
        }
    ...
    static class 3 implements Callable<Void> {
        final /* synthetic */ Context val$applicationContext;
        final /* synthetic */ InitializeCallback val$callback;

        3(InitializeCallback initializeCallback, Context context) {
    ...
    public static synchronized void sdkInitialize(Context applicationContext, InitializeCallback callback) {
        synchronized (FacebookSdk.class) {
            if (!sdkInitialized.booleanValue()) {
                ...
                getExecutor().execute(new FutureTask(new 3(callback, applicationContext)));
