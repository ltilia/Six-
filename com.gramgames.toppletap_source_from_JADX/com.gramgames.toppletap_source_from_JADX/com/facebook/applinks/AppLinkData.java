...
public class AppLinkData {
    ...
    static class 1 implements Runnable {
        ...
        1(Context context, String str, CompletionHandler completionHandler) {
    ...
    public static void fetchDeferredAppLinkData(Context context, String applicationId, CompletionHandler completionHandler) {
        ...
        FacebookSdk.getExecutor().execute(new 1(context.getApplicationContext(), applicationId, completionHandler));
    }
    ...
    private static void fetchDeferredAppLinkFromServer(Context context, String applicationId, CompletionHandler completionHandler) {
        ...
        try {
            deferredApplinkParams.put(NotificationCompatApi21.CATEGORY_EVENT, DEFERRED_APP_LINK_EVENT);
