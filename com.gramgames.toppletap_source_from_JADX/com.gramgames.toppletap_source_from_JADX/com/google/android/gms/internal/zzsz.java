...
public interface zzsz {
    ...
    public static final class zzb extends zzso<zzb> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.zzbuN.equals(BuildConfig.FLAVOR)) {
        ...
        protected int zzz() {
            ...
            return !this.version.equals(BuildConfig.FLAVOR) ? zzz + zzsn.zzo(3, this.version) : zzz;
        }
    }
    ...
    public static final class zzd extends zzso<zzd> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.zzbvc.equals(BuildConfig.FLAVOR)) {
    ...
    public static final class zze extends zzso<zze> {
        ...
        protected int zzz() {
            ...
            return !this.value.equals(BuildConfig.FLAVOR) ? zzz + zzsn.zzo(2, this.value) : zzz;
        }
    }
}
