...
public class zzbh {
    ...
    class 1 implements Comparator<String> {
        ...
        1(zzbh com_google_android_gms_internal_zzbh) {
    ...
    class 2 implements Comparator<com.google.android.gms.internal.zzbk.zza> {
        final /* synthetic */ zzbh zztt;

        2(zzbh com_google_android_gms_internal_zzbh) {
            this.zztt = com_google_android_gms_internal_zzbh;
        }
    ...
    static class zza {
        ...
        public zza() {
            this.zztu = new ByteArrayOutputStream(Connections.MAX_RELIABLE_MESSAGE_LEN);
    ...
    String zzw(String str) {
        ...
        zza zzcM = zzcM();
        PriorityQueue priorityQueue = new PriorityQueue(this.zztq, new 2(this));
