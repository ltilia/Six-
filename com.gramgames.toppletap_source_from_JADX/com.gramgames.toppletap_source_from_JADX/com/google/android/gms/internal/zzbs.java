...
public class zzbs {
    ...
    class 1 implements Callable<T> {
        ...
        1(zzbs com_google_android_gms_internal_zzbs, zzbp com_google_android_gms_internal_zzbp) {
    ...
    public <T> T zzd(zzbp<T> com_google_android_gms_internal_zzbp_T) {
        synchronized (this.zzpV) {
            if (this.zzqA) {
                return zzjb.zzb(new 1(this, com_google_android_gms_internal_zzbp_T));
            }
