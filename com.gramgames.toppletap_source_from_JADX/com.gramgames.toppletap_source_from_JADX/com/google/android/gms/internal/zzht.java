...
public class zzht extends zzb implements zzhw {
    ...
    class 1 implements Runnable {
        ...
        1(zzht com_google_android_gms_internal_zzht, zza com_google_android_gms_internal_zzif_zza) {
            this.zzKy = com_google_android_gms_internal_zzht;
            this.zzps = com_google_android_gms_internal_zzif_zza;
        }

        public void run() {
            this.zzKy.zzb(new zzif(this.zzps, null, null, null, null, null, null));
        }
    }
    ...
    private zza zzc(zza com_google_android_gms_internal_zzif_zza) {
        ...
        try {
            ...
            return new zza(com_google_android_gms_internal_zzif_zza.zzLd, com_google_android_gms_internal_zzif_zza.zzLe, new zzeo(Arrays.asList(new zzen[]{com_google_android_gms_internal_zzen}), -1, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), BuildConfig.FLAVOR, -1, 0, 1, null, 0, -1, -1), com_google_android_gms_internal_zzif_zza.zzrp, com_google_android_gms_internal_zzif_zza.errorCode, com_google_android_gms_internal_zzif_zza.zzKY, com_google_android_gms_internal_zzif_zza.zzKZ, com_google_android_gms_internal_zzif_zza.zzKT);
        } catch (Throwable e) {
