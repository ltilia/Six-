...
class zzjt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzjp {
    ...
    class 1 implements Runnable {
        ...
        1(zzjt com_google_android_gms_internal_zzjt) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        synchronized (this.zzpV) {
            if (isDestroyed()) {
                ...
                mode = (mode == Cue.TYPE_UNSET || mode == 1073741824) ? size : Integer.MAX_VALUE;
                if (mode2 == Cue.TYPE_UNSET || mode2 == 1073741824) {
                    i = size2;
                }
    ...
    public void zzfr() {
        ...
        hashMap.put(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, this.zzpT.afmaVersion);
        zza("onshow", hashMap);
    }
