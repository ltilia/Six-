...
public class zzgx implements zza<zzd> {
    ...
    public zzd zzb(zzgw com_google_android_gms_internal_zzgw, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        ...
        Future zza2 = com_google_android_gms_internal_zzgw.zza(jSONObject, NotificationReciever.DEFAULT_ICON, true, this.zzHc);
        ...
        return new zzd(jSONObject.getString("headline"), arrayList, jSONObject.getString(UnityAdsConstants.UNITY_ADS_FAILED_URL_BODY_KEY), (zzch) zza2.get(), jSONObject.getString("call_to_action"), jSONObject.optDouble("rating", -1.0d), jSONObject.optString("store"), jSONObject.optString("price"), (com.google.android.gms.ads.internal.formats.zza) zzf.get(), new Bundle());
    }
}
