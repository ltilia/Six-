...
public final class zzsm {
    ...
    private zzsm(byte[] bArr, int i, int i2) {
        this.zzbue = MoPubClientPositioning.NO_REPEAT;
        this.zzbug = 64;
        this.zzbuh = 67108864;
        this.buffer = bArr;
        this.zzbtZ = i;
    ...
    public String readString() throws IOException {
        int zzJf = zzJf();
        if (zzJf > this.zzbua - this.zzbuc || zzJf <= 0) {
            return new String(zzmt(zzJf), C.UTF8_NAME);
        }
        String str = new String(this.buffer, this.zzbuc, zzJf, C.UTF8_NAME);
        this.zzbuc = zzJf + this.zzbuc;
        return str;
    }
    ...
    public long zzJg() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            ...
            if ((zzJm & RadialCountdown.BACKGROUND_ALPHA) == 0) {
                return j;
            }
        }
        throw zzst.zzJu();
    ...
    public int zzJh() throws IOException {
        return (((zzJm() & RadialCountdown.PROGRESS_ALPHA) | ((zzJm() & RadialCountdown.PROGRESS_ALPHA) << 8)) | ((zzJm() & RadialCountdown.PROGRESS_ALPHA) << 16)) | ((zzJm() & RadialCountdown.PROGRESS_ALPHA) << 24);
    }
    ...
    public int zzJk() {
        if (this.zzbue == MoPubClientPositioning.NO_REPEAT) {
            return -1;
        }
