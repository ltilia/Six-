...
public class zzgw implements Callable<zzif> {
    ...
    class 1 implements zzdf {
        ...
        1(zzgw com_google_android_gms_internal_zzgw, zzed com_google_android_gms_internal_zzed, zzb com_google_android_gms_internal_zzgw_zzb, zzjd com_google_android_gms_internal_zzjd) {
    ...
    class 2 implements Runnable {
        ...
        2(zzgw com_google_android_gms_internal_zzgw, zzjd com_google_android_gms_internal_zzjd, String str) {
            this.zzGP = com_google_android_gms_internal_zzgw;
    ...
    class 3 implements zzdf {
        ...
        3(zzgw com_google_android_gms_internal_zzgw, zzf com_google_android_gms_ads_internal_formats_zzf) {
            this.zzGP = com_google_android_gms_internal_zzgw;
    ...
    class 4 implements com.google.android.gms.internal.zzjf.zza<List<zzc>, com.google.android.gms.ads.internal.formats.zza> {
        final /* synthetic */ zzgw zzGP;
        ...
        4(zzgw com_google_android_gms_internal_zzgw, String str, Integer num, Integer num2, int i, int i2, int i3) {
            this.zzGP = com_google_android_gms_internal_zzgw;
            this.zzGT = str;
            this.zzGU = num;
            this.zzGV = num2;
    ...
    class 5 implements com.google.android.gms.internal.zziw.zza<zzc> {
        final /* synthetic */ String zzDr;
        final /* synthetic */ zzgw zzGP;
        final /* synthetic */ boolean zzGZ;
        final /* synthetic */ double zzHa;

        5(zzgw com_google_android_gms_internal_zzgw, boolean z, double d, String str) {
            this.zzGP = com_google_android_gms_internal_zzgw;
            this.zzGZ = z;
            this.zzHa = d;
            this.zzDr = str;
    ...
    private zzjg<zzc> zza(JSONObject jSONObject, boolean z, boolean z2) throws JSONException {
        String string = z ? jSONObject.getString(UnityAdsConstants.UNITY_ADS_FAILED_URL_URL_KEY) : jSONObject.optString(UnityAdsConstants.UNITY_ADS_FAILED_URL_URL_KEY);
        double optDouble = jSONObject.optDouble("scale", 1.0d);
        if (!TextUtils.isEmpty(string)) {
            return z2 ? new zzje(new zzc(null, Uri.parse(string), optDouble)) : this.zzGG.zza(string, new 5(this, z, optDouble, string));
        } else {
            zza(0, z);
    ...
    private void zza(com.google.android.gms.ads.internal.formats.zzh.zza com_google_android_gms_ads_internal_formats_zzh_zza, zzed com_google_android_gms_internal_zzed) {
        if (com_google_android_gms_ads_internal_formats_zzh_zza instanceof zzf) {
            ...
            zzdf 3 = new 3(this, com_google_android_gms_ads_internal_formats_zzf);
            com_google_android_gms_internal_zzgw_zzb.zzHb = 3;
            com_google_android_gms_internal_zzed.zza("/nativeAdCustomClick", 3);
        }
    }
    ...
    private JSONObject zzb(zzed com_google_android_gms_internal_zzed) throws TimeoutException, JSONException {
        ...
        zzb com_google_android_gms_internal_zzgw_zzb = new zzb(this);
        zzdf 1 = new 1(this, com_google_android_gms_internal_zzed, com_google_android_gms_internal_zzgw_zzb, com_google_android_gms_internal_zzjd);
        com_google_android_gms_internal_zzgw_zzb.zzHb = 1;
        com_google_android_gms_internal_zzed.zza("/nativeAdPreProcess", 1);
    ...
    private zzed zzgm() throws CancellationException, ExecutionException, InterruptedException, TimeoutException {
        ...
        zzed com_google_android_gms_internal_zzed = (zzed) this.zzGI.zza(this.mContext, this.zzGd.zzLd.zzrl, (this.zzGd.zzLe.zzEF.indexOf(Constants.HTTPS) == 0 ? "https:" : "http:") + ((String) zzbt.zzwC.get()), this.zzyt).get(zzGF, TimeUnit.MILLISECONDS);
    ...
    protected zza zze(JSONObject jSONObject) throws JSONException, TimeoutException {
        ...
        if ("3".equals(string)) {
            ...
            zzjd com_google_android_gms_internal_zzjd = new zzjd();
            zzir.zzMc.post(new 2(this, com_google_android_gms_internal_zzjd, string2));
    ...
    public zzjg<com.google.android.gms.ads.internal.formats.zza> zzf(JSONObject jSONObject) throws JSONException {
        ...
        return zzjf.zza(zzjf.zzl(arrayList), new 4(this, optString, zzb2, zzb, optInt, optInt3, optInt2));
    }
