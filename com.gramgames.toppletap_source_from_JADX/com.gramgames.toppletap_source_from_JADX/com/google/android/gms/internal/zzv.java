...
public class zzv implements zzb {
    ...
    public zzv(File file, int i) {
        this.zzax = new LinkedHashMap(16, AdaptiveEvaluator.DEFAULT_BANDWIDTH_FRACTION, true);
        this.zzay = 0;
        this.zzaz = file;
        this.zzaA = i;
    }
    ...
    static void zza(OutputStream outputStream, int i) throws IOException {
        outputStream.write((i >> 0) & RadialCountdown.PROGRESS_ALPHA);
        outputStream.write((i >> 8) & RadialCountdown.PROGRESS_ALPHA);
        outputStream.write((i >> 16) & RadialCountdown.PROGRESS_ALPHA);
        outputStream.write((i >> 24) & RadialCountdown.PROGRESS_ALPHA);
    }
