...
public class zzgy implements zza<zze> {
    ...
    public zze zzc(zzgw com_google_android_gms_internal_zzgw, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        ...
        return new zze(jSONObject.getString("headline"), arrayList, jSONObject.getString(UnityAdsConstants.UNITY_ADS_FAILED_URL_BODY_KEY), (zzch) zza2.get(), jSONObject.getString("call_to_action"), jSONObject.getString("advertiser"), (com.google.android.gms.ads.internal.formats.zza) zzf.get(), new Bundle());
    }
}
