...
public final class zzbt {
    ...
    static {
        ...
        zzvT = zzbp.zza(0, "gads:video_stream_cache:connect_timeout_millis", (int) CustomEventBannerAdapter.DEFAULT_BANNER_TIMEOUT_DELAY);
        zzvU = zzbp.zza(0, "gads:video:metric_reporting_enabled", Boolean.valueOf(false));
        zzvV = zzbp.zza(0, "gads:video:metric_frame_hash_times", BuildConfig.FLAVOR);
        ...
        zzwX = zzbp.zza(0, "gads:ad_loader:timeout_ms", (long) HlsChunkSource.DEFAULT_PLAYLIST_BLACKLIST_MS);
        zzwY = zzbp.zza(0, "gads:rendering:timeout_ms", (long) HlsChunkSource.DEFAULT_PLAYLIST_BLACKLIST_MS);
