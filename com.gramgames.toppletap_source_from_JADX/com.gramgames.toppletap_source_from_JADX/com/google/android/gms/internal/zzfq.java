...
public class zzfq {
    ...
    public JSONObject toJson() {
        try {
            return new JSONObject().put(AdWebViewClient.SMS, this.zzDu).put(AdWebViewClient.TELEPHONE, this.zzDv).put("calendar", this.zzDw).put("storePicture", this.zzDx).put("inlineVideo", this.zzDy);
        } catch (Throwable e) {
