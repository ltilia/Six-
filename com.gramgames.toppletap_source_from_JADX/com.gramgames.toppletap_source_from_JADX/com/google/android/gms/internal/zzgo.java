...
public class zzgo implements Runnable {
    ...
    public void zza(AdResponseParcel adResponseParcel, zzjy com_google_android_gms_internal_zzjy) {
        ...
        this.zzpD.loadDataWithBaseURL(TextUtils.isEmpty(adResponseParcel.zzEF) ? null : zzr.zzbC().zzaC(adResponseParcel.zzEF), adResponseParcel.body, WebRequest.CONTENT_TYPE_HTML, C.UTF8_NAME, null);
    }
