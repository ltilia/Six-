...
public interface zzgd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgd {
        ...
        private static class zza implements zzgd {
            ...
            public void zza(zzgc com_google_android_gms_internal_zzgc) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzgc != null ? com_google_android_gms_internal_zzgc.asBinder() : null);
        ...
        public static zzgd zzP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgd)) ? new zza(iBinder) : (zzgd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case Yytoken.TYPE_LEFT_BRACE /*1*/:
                    ...
                    zza(com.google.android.gms.internal.zzgc.zza.zzO(data.readStrongBinder()));
    ...
    void zza(zzgc com_google_android_gms_internal_zzgc) throws RemoteException;
}
