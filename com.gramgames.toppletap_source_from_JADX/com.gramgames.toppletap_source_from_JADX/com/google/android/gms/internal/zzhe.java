...
public final class zzhe {
    ...
    static {
        zzJg = new SimpleDateFormat("yyyyMMdd", Locale.US);
    }
    ...
    public static AdResponseParcel zza(Context context, AdRequestInfoParcel adRequestInfoParcel, String str) {
        try {
            ...
            int i = -1;
            if (DeviceInfo.ORIENTATION_PORTRAIT.equals(optString7)) {
                i = zzr.zzbE().zzhw();
            } else if (DeviceInfo.ORIENTATION_LANDSCAPE.equals(optString7)) {
                i = zzr.zzbE().zzhv();
            }
            ...
            if (adResponseParcel != null) {
                ...
                if (adResponseParcel.zzHS > 0) {
                    ...
                    return new AdResponseParcel(adRequestInfoParcel, optString2, str2, list, list2, j, jSONObject.optBoolean("mediation", false), jSONObject.optLong("mediation_config_cache_time_milliseconds", -1), list3, jSONObject.optLong("refresh_interval_milliseconds", -1), i, optString4, j2, optString6, optBoolean, str3, optString, jSONObject.optBoolean("custom_render_allowed", false), z, adRequestInfoParcel.zzHB, jSONObject.optBoolean("content_url_opted_out", true), jSONObject.optBoolean("prefetch", false), jSONObject.optInt("oauth2_token_status", 0), jSONObject.optString("gws_query_id", BuildConfig.FLAVOR), VastIconXmlManager.HEIGHT.equals(jSONObject.optString("fluid", BuildConfig.FLAVOR)), jSONObject.optBoolean("native_express", false), RewardItemParcel.zza(jSONObject.optJSONArray("rewards")), zza(jSONObject.optJSONArray("video_start_urls"), null), zza(jSONObject.optJSONArray("video_complete_urls"), null), jSONObject.optBoolean("use_displayed_impression", false));
                }
            }
            j = j3;
            optString = jSONObject.optString("active_view");
    ...
    public static JSONObject zza(Context context, AdRequestInfoParcel adRequestInfoParcel, zzhj com_google_android_gms_internal_zzhj, zza com_google_android_gms_internal_zzhn_zza, Location location, zzbm com_google_android_gms_internal_zzbm, String str, String str2, List<String> list, Bundle bundle) {
        try {
            ...
            hashMap.put(UnityAdsConstants.UNITY_ADS_WEBVIEW_DATAPARAM_PLATFORM_KEY, Build.MANUFACTURER);
    ...
    private static void zza(HashMap<String, Object> hashMap, AdRequestParcel adRequestParcel) {
        ...
        if (adRequestParcel.versionCode >= 3 && adRequestParcel.zztL != null) {
            hashMap.put(UnityAdsConstants.UNITY_ADS_FAILED_URL_URL_KEY, adRequestParcel.zztL);
        }
    ...
    private static void zza(HashMap<String, Object> hashMap, SearchAdRequestParcel searchAdRequestParcel) {
        ...
        switch (searchAdRequestParcel.zzvi) {
            case Yylex.YYINITIAL /*0*/:
                obj = UnityAdsConstants.UNITY_ADS_WEBVIEW_VIEWTYPE_NONE;
                break;
    ...
    public static JSONObject zzc(AdResponseParcel adResponseParcel) throws JSONException {
        ...
        jSONObject.put("fluid", adResponseParcel.zzul ? VastIconXmlManager.HEIGHT : BuildConfig.FLAVOR);
