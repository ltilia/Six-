...
public class zzjf {
    ...
    static class 1 implements Runnable {
        ...
        1(zzjd com_google_android_gms_internal_zzjd, zza com_google_android_gms_internal_zzjf_zza, zzjg com_google_android_gms_internal_zzjg) {
    ...
    static class 2 implements Runnable {
        ...
        2(AtomicInteger atomicInteger, int i, zzjd com_google_android_gms_internal_zzjd, List list) {
    ...
    public static <A, B> zzjg<B> zza(zzjg<A> com_google_android_gms_internal_zzjg_A, zza<A, B> com_google_android_gms_internal_zzjf_zza_A__B) {
        ...
        com_google_android_gms_internal_zzjg_A.zzb(new 1(com_google_android_gms_internal_zzjd, com_google_android_gms_internal_zzjf_zza_A__B, com_google_android_gms_internal_zzjg_A));
    ...
    public static <V> zzjg<List<V>> zzl(List<zzjg<V>> list) {
        ...
        for (zzjg zzb : list) {
            zzb.zzb(new 2(atomicInteger, size, com_google_android_gms_internal_zzjd, list));
        }
        return com_google_android_gms_internal_zzjd;
    }
