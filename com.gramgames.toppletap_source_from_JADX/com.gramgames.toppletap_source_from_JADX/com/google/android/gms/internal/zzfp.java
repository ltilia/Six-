...
public class zzfp extends zzfs {
    ...
    class 1 implements OnClickListener {
        ...
        1(zzfp com_google_android_gms_internal_zzfp, String str, String str2) {
    ...
    class 2 implements OnClickListener {
        ...
        2(zzfp com_google_android_gms_internal_zzfp) {
            this.zzDt = com_google_android_gms_internal_zzfp;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzr.zzbC().zzaE(zzal)) {
                    ...
                    zzL.setPositiveButton(zzr.zzbF().zzd(R.string.accept, "Accept"), new 1(this, str, zzal));
