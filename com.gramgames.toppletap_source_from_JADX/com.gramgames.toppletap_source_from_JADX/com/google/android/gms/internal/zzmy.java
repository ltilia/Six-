...
public final class zzmy {
    public static String zza(byte[] bArr, int i, int i2, boolean z) {
        ...
        while (i5 > 0) {
            if (i6 == 0) {
                if (i2 < ExecutionOptions.MAX_TRACKING_TAG_STRING_LENGTH) {
            ...
            stringBuilder.append(String.format(" %02X", new Object[]{Integer.valueOf(bArr[i4] & RadialCountdown.PROGRESS_ALPHA)}));
            int i7 = i5 - 1;
            i6++;
            if (z && (i6 == 16 || i7 == 0)) {
                int i8 = 16 - i6;
