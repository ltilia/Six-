...
public class zziu {
    ...
    class 1 implements OnClickListener {
        ...
        1(zziu com_google_android_gms_internal_zziu, String str) {
            this.zzMm = com_google_android_gms_internal_zziu;
            this.zzMl = str;
        }

        public void onClick(DialogInterface dialog, int which) {
            zzr.zzbC().zzb(this.zzMm.mContext, Intent.createChooser(new Intent("android.intent.action.SEND").setType(WebRequest.CONTENT_TYPE_PLAIN_TEXT).putExtra("android.intent.extra.TEXT", this.zzMl), "Share via"));
        }
    }
    ...
    class 2 implements OnClickListener {
        ...
        2(zziu com_google_android_gms_internal_zziu) {
            this.zzMm = com_google_android_gms_internal_zziu;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new 1(this, zzaG));
