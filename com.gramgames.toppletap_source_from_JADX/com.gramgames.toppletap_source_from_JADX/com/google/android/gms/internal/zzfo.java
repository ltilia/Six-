...
public class zzfo {
    ...
    public void execute() {
        ...
        int zzhw = DeviceInfo.ORIENTATION_PORTRAIT.equalsIgnoreCase(this.zzDq) ? zzr.zzbE().zzhw() : DeviceInfo.ORIENTATION_LANDSCAPE.equalsIgnoreCase(this.zzDq) ? zzr.zzbE().zzhv() : this.zzDp ? -1 : zzr.zzbE().zzhx();
