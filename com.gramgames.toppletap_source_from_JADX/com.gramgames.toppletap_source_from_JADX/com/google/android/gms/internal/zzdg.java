...
public class zzdg implements zzdf {
    ...
    class 1 implements Runnable {
        ...
        class 1 implements Runnable {
            ...
            final /* synthetic */ 1 zzzo;

            1(1 1, JSONObject jSONObject) {
                this.zzzo = 1;
        ...
        1(zzdg com_google_android_gms_internal_zzdg, Map map, zzjp com_google_android_gms_internal_zzjp) {
    ...
    protected JSONObject zza(zzd com_google_android_gms_internal_zzdg_zzd) {
        ...
        try {
            ...
            if (com_google_android_gms_internal_zzdg_zzd.getBody() != null) {
                jSONObject.put(UnityAdsConstants.UNITY_ADS_FAILED_URL_BODY_KEY, com_google_android_gms_internal_zzdg_zzd.getBody());
            }
            JSONArray jSONArray = new JSONArray();
            for (zza com_google_android_gms_internal_zzdg_zza : com_google_android_gms_internal_zzdg_zzd.zzdZ()) {
                jSONArray.put(new JSONObject().put(UnityAdsConstants.UNITY_ADS_REWARD_ITEMKEY_KEY, com_google_android_gms_internal_zzdg_zza.getKey()).put("value", com_google_android_gms_internal_zzdg_zza.getValue()));
            }
    ...
    public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
        zziq.zza(new 1(this, map, com_google_android_gms_internal_zzjp));
    }

    protected zzb zzc(JSONObject jSONObject) {
        URL url;
        String optString = jSONObject.optString("http_request_id");
        String optString2 = jSONObject.optString(UnityAdsConstants.UNITY_ADS_FAILED_URL_URL_KEY);
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                arrayList.add(new zza(optJSONObject.optString(UnityAdsConstants.UNITY_ADS_REWARD_ITEMKEY_KEY), optJSONObject.optString("value")));
            }
        }
