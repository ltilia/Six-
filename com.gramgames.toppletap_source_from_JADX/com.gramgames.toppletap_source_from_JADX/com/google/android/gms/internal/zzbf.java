...
public class zzbf extends Thread {
    ...
    class 1 implements Runnable {
        ...
        1(zzbf com_google_android_gms_internal_zzbf, View view) {
    ...
    class 2 implements Runnable {
        ...
        2(zzbf com_google_android_gms_internal_zzbf, zzbc com_google_android_gms_internal_zzbc, WebView webView, boolean z) {
            this.zztg = com_google_android_gms_internal_zzbf;
            this.zzti = com_google_android_gms_internal_zzbc;
            this.zztj = webView;
            this.zztk = z;
            this.zzth = new 1(this);
        }
        ...
        public void run() {
            if (this.zztj.getSettings().getJavaScriptEnabled()) {
                try {
                    ...
                    this.zzth.onReceiveValue(BuildConfig.FLAVOR);
                }
            }
        }
    }
    ...
    boolean zza(WebView webView, zzbc com_google_android_gms_internal_zzbc, boolean z) {
        ...
        com_google_android_gms_internal_zzbc.zzcC();
        webView.post(new 2(this, com_google_android_gms_internal_zzbc, webView, z));
        return true;
    }
