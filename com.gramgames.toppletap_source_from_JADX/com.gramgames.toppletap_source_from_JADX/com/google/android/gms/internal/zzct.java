...
public interface zzct extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzct {
        ...
        private static class zza implements zzct {
            ...
            public void zza(zzcp com_google_android_gms_internal_zzcp, String str) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case Yytoken.TYPE_LEFT_BRACE /*1*/:
                    ...
                    zza(com.google.android.gms.internal.zzcp.zza.zzy(data.readStrongBinder()), data.readString());
    ...
    void zza(zzcp com_google_android_gms_internal_zzcp, String str) throws RemoteException;
}
