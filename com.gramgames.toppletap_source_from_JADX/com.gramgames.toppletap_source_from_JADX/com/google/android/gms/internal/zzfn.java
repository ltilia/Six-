...
public class zzfn extends zzfs {
    ...
    class 1 implements OnClickListener {
        ...
        1(zzfn com_google_android_gms_internal_zzfn) {
    ...
    static {
        zzDa = zzmr.zzc("top-left", "top-right", "top-center", TtmlNode.CENTER, "bottom-left", "bottom-right", "bottom-center");
    }
    ...
    private void zzh(Map<String, String> map) {
        if (!TextUtils.isEmpty((CharSequence) map.get(VastIconXmlManager.WIDTH))) {
            this.zzoG = zzr.zzbC().zzaD((String) map.get(VastIconXmlManager.WIDTH));
        }
        if (!TextUtils.isEmpty((CharSequence) map.get(VastIconXmlManager.HEIGHT))) {
            this.zzoH = zzr.zzbC().zzaD((String) map.get(VastIconXmlManager.HEIGHT));
        }
    ...
    public void zzp(boolean z) {
        synchronized (this.zzpV) {
            if (this.zzDl != null) {
                ...
                if (z) {
                    zzao(UnityAdsConstants.UNITY_ADS_ZONE_DEFAULT_KEY);
                    if (this.zzDk != null) {
                        this.zzDk.zzbf();
                    }
                }
