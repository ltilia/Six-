...
public class zzfs {
    ...
    public zzfs(zzjp com_google_android_gms_internal_zzjp) {
        this(com_google_android_gms_internal_zzjp, BuildConfig.FLAVOR);
    }
    ...
    public void zza(int i, int i2, int i3, int i4, float f, int i5) {
        try {
            this.zzpD.zzb("onScreenInfoChanged", new JSONObject().put(VastIconXmlManager.WIDTH, i).put(VastIconXmlManager.HEIGHT, i2).put("maxSizeWidth", i3).put("maxSizeHeight", i4).put("density", (double) f).put("rotation", i5));
        } catch (Throwable e) {
    ...
    public void zzam(String str) {
        try {
            this.zzpD.zzb("onError", new JSONObject().put(ShareConstants.WEB_DIALOG_PARAM_MESSAGE, str).put(UnityAdsConstants.UNITY_ADS_WEBVIEW_API_ACTION_KEY, this.zzDJ));
        } catch (Throwable e) {
    ...
    public void zzb(int i, int i2, int i3, int i4) {
        try {
            this.zzpD.zzb("onSizeChanged", new JSONObject().put("x", i).put("y", i2).put(VastIconXmlManager.WIDTH, i3).put(VastIconXmlManager.HEIGHT, i4));
        } catch (Throwable e) {
    ...
    public void zzc(int i, int i2, int i3, int i4) {
        try {
            this.zzpD.zzb("onDefaultPositionReceived", new JSONObject().put("x", i).put("y", i2).put(VastIconXmlManager.WIDTH, i3).put(VastIconXmlManager.HEIGHT, i4));
        } catch (Throwable e) {
