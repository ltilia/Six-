        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case Yytoken.TYPE_LEFT_BRACE /*1*/:
                    ...
                    zza(data.readString(), com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case Yytoken.TYPE_RIGHT_BRACE /*2*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
                    zzd zzK = zzK(data.readString());
                    reply.writeNoException();
                    reply.writeStrongBinder(zzK != null ? zzK.asBinder() : null);
                    return true;
                case Yytoken.TYPE_LEFT_SQUARE /*3*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
                    zza(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
