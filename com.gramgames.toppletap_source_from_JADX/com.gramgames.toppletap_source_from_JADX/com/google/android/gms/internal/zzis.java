...
public class zzis {
    ...
    public static class zzb extends zza {
        ...
        class 1 implements Callable<File> {
            final /* synthetic */ zzb zzMg;
            final /* synthetic */ Context zzxh;

            1(zzb com_google_android_gms_internal_zzis_zzb, Context context) {
                this.zzMg = com_google_android_gms_internal_zzis_zzb;
                this.zzxh = context;
            }
        ...
        public boolean zza(Context context, WebSettings webSettings) {
            ...
            if (((File) zzjb.zzb(new 1(this, context))) != null) {
