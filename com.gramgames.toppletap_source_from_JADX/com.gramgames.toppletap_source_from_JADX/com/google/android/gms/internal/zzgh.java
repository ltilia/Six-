...
public interface zzgh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgh {
        ...
        private static class zza implements zzgh {
            ...
            public void zza(zzgg com_google_android_gms_internal_zzgg) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IPlayStorePurchaseListener");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzgg != null ? com_google_android_gms_internal_zzgg.asBinder() : null);
        ...
        public static zzgh zzT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgh)) ? new zza(iBinder) : (zzgh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case Yytoken.TYPE_RIGHT_BRACE /*2*/:
                    data.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IPlayStorePurchaseListener");
                    zza(com.google.android.gms.internal.zzgg.zza.zzS(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(zzgg com_google_android_gms_internal_zzgg) throws RemoteException;
}
