...
public class zzdy {
    ...
    private String zzef() {
        try {
            ...
            while (it.hasNext()) {
                stringBuilder.append(Base64.encodeToString(((zzdz) it.next()).toString().getBytes(C.UTF8_NAME), 0));
                if (it.hasNext()) {
    ...
    void restore() {
        ...
        if (this.zzAz != null) {
            ...
            for (Object obj : zzY(sharedPreferences.getString("PoolKeys", BuildConfig.FLAVOR))) {
