...
public class zziv {
    ...
    public static class zza {
        ...
        public String toString() {
            return zzw.zzy(this).zzg(UnityAdsConstants.UNITY_ADS_ZONE_NAME_KEY, this.name).zzg("minBound", Double.valueOf(this.zzMt)).zzg("maxBound", Double.valueOf(this.zzMs)).zzg("percent", Double.valueOf(this.zzMu)).zzg("count", Integer.valueOf(this.count)).toString();
        }
    }
