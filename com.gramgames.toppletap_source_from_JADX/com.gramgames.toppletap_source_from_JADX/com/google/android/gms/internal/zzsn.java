...
public final class zzsn {
    ...
    private static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < '\u0080' && i5 < i4) {
                ...
                i6 = r6 + 1;
                bArr[r6] = (byte) ((charAt2 & 63) | RadialCountdown.BACKGROUND_ALPHA);
            } else if ((charAt2 < '\ud800' || '\udfff' < charAt2) && i5 <= i4 - 3) {
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 >>> 12) | 480);
                i5 = i6 + 1;
                bArr[i6] = (byte) (((charAt2 >>> 6) & 63) | RadialCountdown.BACKGROUND_ALPHA);
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 & 63) | RadialCountdown.BACKGROUND_ALPHA);
            } else if (i5 <= i4 - 4) {
                if (i3 + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt)) {
                        ...
                        i5 = i6 + 1;
                        bArr[i6] = (byte) (((toCodePoint >>> 12) & 63) | RadialCountdown.BACKGROUND_ALPHA);
                        r6 = i5 + 1;
                        bArr[i5] = (byte) (((toCodePoint >>> 6) & 63) | RadialCountdown.BACKGROUND_ALPHA);
                        i6 = r6 + 1;
                        bArr[r6] = (byte) ((toCodePoint & 63) | RadialCountdown.BACKGROUND_ALPHA);
                    }
                }
    ...
    private static void zzb(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (charAt < '\u0080') {
                ...
                byteBuffer.put((byte) ((charAt & 63) | RadialCountdown.BACKGROUND_ALPHA));
            } else if (charAt < '\ud800' || '\udfff' < charAt) {
                byteBuffer.put((byte) ((charAt >>> 12) | 480));
                byteBuffer.put((byte) (((charAt >>> 6) & 63) | RadialCountdown.BACKGROUND_ALPHA));
                byteBuffer.put((byte) ((charAt & 63) | RadialCountdown.BACKGROUND_ALPHA));
            } else {
                if (i + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt, charAt2)) {
                        ...
                        byteBuffer.put((byte) (((toCodePoint >>> 12) & 63) | RadialCountdown.BACKGROUND_ALPHA));
                        byteBuffer.put((byte) (((toCodePoint >>> 6) & 63) | RadialCountdown.BACKGROUND_ALPHA));
                        byteBuffer.put((byte) ((toCodePoint & 63) | RadialCountdown.BACKGROUND_ALPHA));
                    }
                }
    ...
    public void zzau(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzmz((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | RadialCountdown.BACKGROUND_ALPHA);
            j >>>= 7;
        }
        zzmz((int) j);
    }
    ...
    public void zzmB(int i) throws IOException {
        while ((i & -128) != 0) {
            zzmz((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | RadialCountdown.BACKGROUND_ALPHA);
            i >>>= 7;
        }
        zzmz(i);
    }
