...
public class zzir {
    ...
    class 1 implements Runnable {
        ...
        1(zzir com_google_android_gms_internal_zzir, Context context) {
    ...
    public boolean zzI(Context context) {
        ...
        if ((resolveActivity.activityInfo.configChanges & RadialCountdown.BACKGROUND_ALPHA) == 0) {
        ...
        if ((resolveActivity.activityInfo.configChanges & AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT) == 0) {
            zzb.zzaK(String.format(str, new Object[]{UnityAdsConstants.UNITY_ADS_WEBVIEW_DATAPARAM_SCREENSIZE_KEY}));
            z = false;
        }
                ...
                if (!adSizeParcel.zzui) {
                    ...
                    while (view != null) {
                        ...
                        if (parent != null) {
                            ...
                            jSONObject3.put(UnityAdsConstants.UNITY_ADS_ANALYTICS_QUERYPARAM_EVENTTYPE_KEY, parent.getClass().getName());
    ...
    public void zza(Context context, @Nullable String str, String str2, Bundle bundle, boolean z) {
        ...
        Uri.Builder appendQueryParameter = new Uri.Builder().scheme(Constants.HTTPS).path("//pagead2.googlesyndication.com/pagead/gen_204").appendQueryParameter(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY, str2);
    ...
    public void zza(Context context, String str, boolean z, HttpURLConnection httpURLConnection, String str2) {
        httpURLConnection.setConnectTimeout(com.adjust.sdk.Constants.SOCKET_TIMEOUT);
        httpURLConnection.setInstanceFollowRedirects(z);
        httpURLConnection.setReadTimeout(com.adjust.sdk.Constants.SOCKET_TIMEOUT);
