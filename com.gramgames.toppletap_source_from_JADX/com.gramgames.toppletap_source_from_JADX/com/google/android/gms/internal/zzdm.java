        ...
        if (str == null) {
            ...
            if ("expand".equalsIgnoreCase(str)) {
                ...
                if (str != null) {
                    ...
                    zzhU.zza(zzc(map), zzd(map), (String) map.get(AdType.HTML), (String) map.get("baseurl"));
                }
            ...
            } else if ("app".equalsIgnoreCase(str) && ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase((String) map.get("play_store"))) {
                ...
                zzo(true);
                str = (String) map.get("u");
                zzhU.zza(new AdLauncherIntentInfoParcel((String) map.get("i"), !TextUtils.isEmpty(str) ? zzr.zzbC().zza(com_google_android_gms_internal_zzjp, str) : str, (String) map.get("m"), (String) map.get(TtmlNode.TAG_P), (String) map.get("c"), (String) map.get("f"), (String) map.get("e")));
            }
        } else {
