        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case Yytoken.TYPE_RIGHT_BRACE /*2*/:
                    ...
                    zza(authAccountRequest, com.google.android.gms.signin.internal.zzd.zza.zzea(data.readStrongBinder()));
                ...
                case Yytoken.TYPE_COMMA /*5*/:
                    ...
                    zza(resolveAccountRequest, com.google.android.gms.common.internal.zzt.zza.zzaT(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                ...
                case UnityAdsDeviceLog.LOGLEVEL_DEBUG /*8*/:
                    ...
                    zza(readInt, account, com.google.android.gms.signin.internal.zzd.zza.zzea(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case R.styleable.Toolbar_popupTheme /*9*/:
                    data.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                    zzp zzaP = com.google.android.gms.common.internal.zzp.zza.zzaP(data.readStrongBinder());
                ...
                case R.styleable.Toolbar_titleTextAppearance /*10*/:
                    ...
                    zza(recordConsentRequest, com.google.android.gms.signin.internal.zzd.zza.zzea(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case R.styleable.Toolbar_subtitleTextAppearance /*11*/:
                    data.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                    zzb(com.google.android.gms.signin.internal.zzd.zza.zzea(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case R.styleable.Toolbar_titleMargins /*12*/:
                    ...
                    zza(signInRequest, com.google.android.gms.signin.internal.zzd.zza.zzea(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
