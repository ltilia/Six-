...
public class zzq extends zzk<UserMetadata> {
    ...
    private static Collection<String> zzdg(String str) {
        return Arrays.asList(new String[]{zzB(str, "permissionId"), zzB(str, "displayName"), zzB(str, UnityAdsConstants.UNITY_ADS_REWARD_PICTURE_KEY), zzB(str, "isAuthenticatedUser"), zzB(str, "emailAddress")});
    }
    ...
    protected UserMetadata zzj(DataHolder dataHolder, int i, int i2) {
        ...
        String zzd3 = dataHolder.zzd(zzdf(UnityAdsConstants.UNITY_ADS_REWARD_PICTURE_KEY), i, i2);
