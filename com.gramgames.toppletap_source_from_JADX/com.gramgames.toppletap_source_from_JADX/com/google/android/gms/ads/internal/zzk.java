...
public class zzk extends zzc implements zzdj, com.google.android.gms.internal.zzdn.zza {
    ...
    private class zzb extends zzim {
        ...
        class 1 implements Runnable {
            final /* synthetic */ AdOverlayInfoParcel zzqj;
            final /* synthetic */ zzb zzqk;

            1(zzb com_google_android_gms_ads_internal_zzk_zzb, AdOverlayInfoParcel adOverlayInfoParcel) {
                this.zzqk = com_google_android_gms_ads_internal_zzk_zzb;
                this.zzqj = adOverlayInfoParcel;
            }

            public void run() {
                zzr.zzbA().zza(this.zzqk.zzqh.zzpj.context, this.zzqj);
            }
        }
        ...
        public void zzbr() {
            ...
            zzir.zzMc.post(new 1(this, new AdOverlayInfoParcel(this.zzqh, this.zzqh, this.zzqh, this.zzqh.zzpj.zzrq.zzED, requestedOrientation, this.zzqh.zzpj.zzrl, this.zzqh.zzpj.zzrq.zzHY, interstitialAdParameterParcel)));
        }
    }
    ...
    public void showInterstitial() {
        ...
        if (((Boolean) zzbt.zzwN.get()).booleanValue()) {
            ...
            if (!zzr.zzbC().zzO(this.zzpj.context)) {
                ...
                bundle = new Bundle();
                bundle.putString("appid", packageName);
                bundle.putString(UnityAdsConstants.UNITY_ADS_WEBVIEW_API_ACTION_KEY, "show_interstitial_app_not_in_foreground");
                zzb(bundle);
            }
        }
        if (!this.zzpj.zzbX()) {
