...
public final class zzs implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public String zzca() {
        return (this.zzrR && this.zzrS) ? BuildConfig.FLAVOR : this.zzrR ? this.zzrT ? "top-scrollable" : "top-locked" : this.zzrS ? this.zzrT ? "bottom-scrollable" : "bottom-locked" : BuildConfig.FLAVOR;
    }
