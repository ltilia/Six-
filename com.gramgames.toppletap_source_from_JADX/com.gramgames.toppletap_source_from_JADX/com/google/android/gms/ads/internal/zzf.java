...
public class zzf extends zzc implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class 1 implements zzb {
        final /* synthetic */ zzif zzpF;
        final /* synthetic */ zzf zzpG;

        1(zzf com_google_android_gms_ads_internal_zzf, zzif com_google_android_gms_internal_zzif) {
            this.zzpG = com_google_android_gms_ads_internal_zzf;
            this.zzpF = com_google_android_gms_internal_zzif;
        }

        public void zzbi() {
            this.zzpG.zzpl.zza(this.zzpG.zzpj.zzrp, this.zzpF).zza(this.zzpF.zzED);
        }
    }
    ...
    private void zzd(zzif com_google_android_gms_internal_zzif) {
        if (this.zzpj.zzbW()) {
            if (com_google_android_gms_internal_zzif.zzED != null) {
                ...
                if (com_google_android_gms_internal_zzif.zzcv()) {
                    ...
                    com_google_android_gms_internal_zzif.zzED.zzhU().zza(new 1(this, com_google_android_gms_internal_zzif));
                }
            }
