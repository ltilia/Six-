...
public class zzq {
    ...
    class 1 implements Runnable {
        ...
        1(zzq com_google_android_gms_ads_internal_zzq, WeakReference weakReference) {
            this.zzqM = com_google_android_gms_ads_internal_zzq;
            this.zzqL = weakReference;
        }

        public void run() {
            this.zzqM.zzqI = false;
            zza com_google_android_gms_ads_internal_zza = (zza) this.zzqL.get();
    ...
    zzq(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzq_zza) {
        ...
        this.zzx = new 1(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
