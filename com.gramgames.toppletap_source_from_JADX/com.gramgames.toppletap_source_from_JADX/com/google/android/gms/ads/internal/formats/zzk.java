...
public class zzk extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class 1 implements Runnable {
        final /* synthetic */ zzi zzyJ;
        final /* synthetic */ zzk zzyK;

        1(zzk com_google_android_gms_ads_internal_formats_zzk, zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyK = com_google_android_gms_ads_internal_formats_zzk;
            this.zzyJ = com_google_android_gms_ads_internal_formats_zzi;
        }

        public void run() {
            zzjp zzdR = this.zzyJ.zzdR();
            if (zzdR != null) {
    ...
    public void zza(zzd com_google_android_gms_dynamic_zzd) {
        synchronized (this.zzpV) {
            ...
            if (zzp instanceof zzi) {
                zzi com_google_android_gms_ads_internal_formats_zzi = (zzi) zzp;
                ...
                zzir.zzMc.post(new 1(this, com_google_android_gms_ads_internal_formats_zzi));
