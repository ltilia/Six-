...
public class zzm {
    ...
    static class 1 implements zza {
        ...
        1(zzd com_google_android_gms_ads_internal_formats_zzd, String str, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, boolean z) {
            try {
                ...
                jSONObject.put(AppLinkData.ARGUMENTS_EXTRAS_KEY, zzm.zza(this.zzqq.getExtras(), this.zzqr));
    ...
    static class 2 implements zza {
        final /* synthetic */ String zzqr;
        final /* synthetic */ zzjp zzqs;
        final /* synthetic */ zze zzqt;

        2(zze com_google_android_gms_ads_internal_formats_zze, String str, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, boolean z) {
            try {
                ...
                jSONObject.put("images", jSONArray);
                jSONObject.put(AppLinkData.ARGUMENTS_EXTRAS_KEY, zzm.zza(this.zzqt.getExtras(), this.zzqr));
                JSONObject jSONObject2 = new JSONObject();
                jSONObject2.put("assets", jSONObject);
    ...
    static class 5 implements zzdf {
        ...
        5(zzfb com_google_android_gms_internal_zzfb, zzf.zza com_google_android_gms_ads_internal_zzf_zza, zzfc com_google_android_gms_internal_zzfc) {
    ...
    static zzdf zza(zzfb com_google_android_gms_internal_zzfb, zzfc com_google_android_gms_internal_zzfc, zzf.zza com_google_android_gms_ads_internal_zzf_zza) {
        return new 5(com_google_android_gms_internal_zzfb, com_google_android_gms_ads_internal_zzf_zza, com_google_android_gms_internal_zzfc);
    }
    ...
    public static void zza(zzif com_google_android_gms_internal_zzif, zzf.zza com_google_android_gms_ads_internal_zzf_zza) {
        if (zzg(com_google_android_gms_internal_zzif)) {
            ...
            try {
                ...
                } else if (!list.contains(AppEventsConstants.EVENT_PARAM_VALUE_YES) || zzeG == null) {
    ...
    private static void zza(zzjp com_google_android_gms_internal_zzjp, zzd com_google_android_gms_ads_internal_formats_zzd, String str) {
        com_google_android_gms_internal_zzjp.zzhU().zza(new 1(com_google_android_gms_ads_internal_formats_zzd, str, com_google_android_gms_internal_zzjp));
    }
    ...
    private static void zza(zzjp com_google_android_gms_internal_zzjp, zze com_google_android_gms_ads_internal_formats_zze, String str) {
        com_google_android_gms_internal_zzjp.zzhU().zza(new 2(com_google_android_gms_ads_internal_formats_zze, str, com_google_android_gms_internal_zzjp));
    }
    ...
    private static boolean zzb(zzjp com_google_android_gms_internal_zzjp, zzes com_google_android_gms_internal_zzes, CountDownLatch countDownLatch) throws RemoteException {
        ...
        if (str2 != null) {
            com_google_android_gms_internal_zzjp.loadDataWithBaseURL(str2, str, WebRequest.CONTENT_TYPE_HTML, C.UTF8_NAME, null);
        } else {
            com_google_android_gms_internal_zzjp.loadData(str, WebRequest.CONTENT_TYPE_HTML, C.UTF8_NAME);
        }
        return true;
    }
