...
public abstract class zzb extends zza implements zzg, zzj, zzdh, zzep {
    ...
    class 1 implements Runnable {
        final /* synthetic */ Intent zzpp;
        final /* synthetic */ zzb zzpq;

        1(zzb com_google_android_gms_ads_internal_zzb, Intent intent) {
            this.zzpq = com_google_android_gms_ads_internal_zzb;
            this.zzpp = intent;
        }

        public void run() {
            int zzd = zzr.zzbM().zzd(this.zzpp);
            zzr.zzbM();
    ...
    public void zza(String str, boolean z, int i, Intent intent, zzf com_google_android_gms_ads_internal_purchase_zzf) {
        ...
        zzir.zzMc.postDelayed(new 1(this, intent), 500);
    }
