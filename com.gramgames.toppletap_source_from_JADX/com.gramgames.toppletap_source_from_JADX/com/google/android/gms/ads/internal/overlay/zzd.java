...
public class zzd extends com.google.android.gms.internal.zzfv.zza implements zzs {
    ...
    class 1 implements com.google.android.gms.internal.zzjq.zza {
        final /* synthetic */ zzd zzEv;

        1(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzim {
        ...
        class 1 implements Runnable {
            final /* synthetic */ Drawable zzEy;
            final /* synthetic */ zzd zzEz;

            1(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
                this.zzEz = com_google_android_gms_ads_internal_overlay_zzd_zzd;
                this.zzEy = drawable;
            }

            public void run() {
                this.zzEz.zzEv.mActivity.getWindow().setBackgroundDrawable(this.zzEy);
            }
        }
        ...
        public void zzbr() {
            ...
            if (zzf != null) {
                zzir.zzMc.post(new 1(this, zzr.zzbE().zza(this.zzEv.mActivity, zzf, this.zzEv.zzEh.zzEM.zzqo, this.zzEv.zzEh.zzEM.zzqp)));
            }
        }
    }

    static {
        zzEg = Color.argb(0, 0, 0, 0);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            this.zzDm.setId(AdError.NETWORK_ERROR_CODE);
    ...
    public void zza(View view, CustomViewCallback customViewCallback) {
        ...
        this.zzEl.setBackgroundColor(CtaButton.BACKGROUND_COLOR);
    ...
    protected void zzx(boolean z) throws zza {
        ...
        if (this.zzEo) {
            ...
            this.zzDm.setBackgroundColor(CtaButton.BACKGROUND_COLOR);
        }
        this.mActivity.setContentView(this.zzDm);
        zzaD();
        if (z) {
            ...
            this.zzpD.zzhU().zza(new 1(this));
            if (this.zzEh.url != null) {
                this.zzpD.loadUrl(this.zzEh.url);
            } else if (this.zzEh.zzEH != null) {
                this.zzpD.loadDataWithBaseURL(this.zzEh.zzEF, this.zzEh.zzEH, WebRequest.CONTENT_TYPE_HTML, C.UTF8_NAME, null);
            } else {
