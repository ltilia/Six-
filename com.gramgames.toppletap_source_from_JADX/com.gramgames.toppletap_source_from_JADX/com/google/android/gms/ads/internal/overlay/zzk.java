...
public class zzk extends FrameLayout implements zzh {
    ...
    public zzk(Context context, zzjp com_google_android_gms_internal_zzjp, int i, zzcb com_google_android_gms_internal_zzcb, zzbz com_google_android_gms_internal_zzbz) {
        ...
        this.zzES.setBackgroundColor(CtaButton.BACKGROUND_COLOR);
        zzfG();
    ...
    private void zzfJ() {
        if (this.zzpD.zzhP() != null && !this.zzEQ) {
            this.zzER = (this.zzpD.zzhP().getWindow().getAttributes().flags & RadialCountdown.BACKGROUND_ALPHA) != 0;
            if (!this.zzER) {
                this.zzpD.zzhP().getWindow().addFlags(RadialCountdown.BACKGROUND_ALPHA);
                this.zzEQ = true;
            }
        }
    }
    ...
    private void zzfK() {
        if (this.zzpD.zzhP() != null && this.zzEQ && !this.zzER) {
            this.zzpD.zzhP().getWindow().clearFlags(RadialCountdown.BACKGROUND_ALPHA);
            this.zzEQ = false;
        }
    }
