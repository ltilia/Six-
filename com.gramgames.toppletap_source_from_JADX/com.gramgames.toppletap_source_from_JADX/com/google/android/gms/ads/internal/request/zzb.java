...
public class zzb extends zzim implements com.google.android.gms.ads.internal.request.zzc.zza {
    ...
    class 1 implements Runnable {
        ...
        1(zzb com_google_android_gms_ads_internal_request_zzb) {
            this.zzHj = com_google_android_gms_ads_internal_request_zzb;
        }
    ...
    class 2 implements Runnable {
        final /* synthetic */ zzb zzHj;
        final /* synthetic */ zzji zzHk;

        2(zzb com_google_android_gms_ads_internal_request_zzb, zzji com_google_android_gms_internal_zzji) {
            this.zzHj = com_google_android_gms_ads_internal_request_zzb;
            this.zzHk = com_google_android_gms_internal_zzji;
        }

        public void run() {
            synchronized (this.zzHj.zzGg) {
                this.zzHj.zzHi = this.zzHj.zza(this.zzHj.zzHh.zzrl, this.zzHk);
                if (this.zzHj.zzHi == null) {
    ...
    public void zzbr() {
        ...
        this.zzGf = new 1(this);
        zzir.zzMc.postDelayed(this.zzGf, ((Long) zzbt.zzwX.get()).longValue());
        zzji com_google_android_gms_internal_zzjj = new zzjj();
        long elapsedRealtime = zzr.zzbG().elapsedRealtime();
        zziq.zza(new 2(this, com_google_android_gms_internal_zzjj));
