...
public final class LeaderboardVariantEntity implements LeaderboardVariant {
    ...
    static String zzb(LeaderboardVariant leaderboardVariant) {
        return zzw.zzy(leaderboardVariant).zzg("TimeSpan", TimeSpan.zzgw(leaderboardVariant.getTimeSpan())).zzg("Collection", LeaderboardCollection.zzgw(leaderboardVariant.getCollection())).zzg("RawPlayerScore", leaderboardVariant.hasPlayerInfo() ? Long.valueOf(leaderboardVariant.getRawPlayerScore()) : UnityAdsConstants.UNITY_ADS_WEBVIEW_VIEWTYPE_NONE).zzg("DisplayPlayerScore", leaderboardVariant.hasPlayerInfo() ? leaderboardVariant.getDisplayPlayerScore() : UnityAdsConstants.UNITY_ADS_WEBVIEW_VIEWTYPE_NONE).zzg("PlayerRank", leaderboardVariant.hasPlayerInfo() ? Long.valueOf(leaderboardVariant.getPlayerRank()) : UnityAdsConstants.UNITY_ADS_WEBVIEW_VIEWTYPE_NONE).zzg("DisplayPlayerRank", leaderboardVariant.hasPlayerInfo() ? leaderboardVariant.getDisplayPlayerRank() : UnityAdsConstants.UNITY_ADS_WEBVIEW_VIEWTYPE_NONE).zzg("NumScores", Long.valueOf(leaderboardVariant.getNumScores())).zzg("TopPageNextToken", leaderboardVariant.zzxL()).zzg("WindowPageNextToken", leaderboardVariant.zzxN()).zzg("WindowPagePrevToken", leaderboardVariant.zzxM()).toString();
    }
