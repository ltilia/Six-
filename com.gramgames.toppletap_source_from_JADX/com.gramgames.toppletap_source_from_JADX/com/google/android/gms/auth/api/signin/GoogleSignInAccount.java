...
public class GoogleSignInAccount implements SafeParcelable {
    ...
    static class 1 implements Comparator<Scope> {
        1() {
        }
    ...
    public static GoogleSignInAccount zzbH(@Nullable String str) throws JSONException {
        ...
        return zza(jSONObject.optString(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY), jSONObject.optString("tokenId", null), jSONObject.optString(Scopes.EMAIL, null), jSONObject.optString("displayName", null), parse, Long.valueOf(parseLong), jSONObject.getString("obfuscatedIdentifier"), hashSet).zzbI(jSONObject.optString("serverAuthCode", null));
    }
    ...
    private JSONObject zzmJ() {
        ...
        try {
            if (getId() != null) {
                jSONObject.put(UnityAdsConstants.UNITY_ADS_ZONE_ID_KEY, getId());
            }
            if (getIdToken() != null) {
    ...
    public boolean equals(Object obj) {
        return !(obj instanceof GoogleSignInAccount) ? false : ((GoogleSignInAccount) obj).zzmI().equals(zzmI());
    }
