...
public class SignInAccount implements SafeParcelable {
    ...
    public static SignInAccount zza(zzd com_google_android_gms_auth_api_signin_zzd, String str, String str2, String str3, Uri uri, String str4, String str5) {
        String str6 = null;
        if (com_google_android_gms_auth_api_signin_zzd != null) {
            str6 = com_google_android_gms_auth_api_signin_zzd.zzmT();
        }
    ...
    public static SignInAccount zzbM(String str) throws JSONException {
        ...
        return zza(zzd.zzbL(jSONObject.optString(UnityAdsConstants.UNITY_ADS_ANALYTICS_QUERYPARAM_PROVIDERID_KEY, null)), jSONObject.optString("tokenId", null), jSONObject.getString(Scopes.EMAIL), jSONObject.optString("displayName", null), !TextUtils.isEmpty(optString) ? Uri.parse(optString) : null, jSONObject.getString("localId"), jSONObject.optString("refreshToken")).zza(GoogleSignInAccount.zzbH(jSONObject.optString("googleSignInAccount")));
    }
    ...
    private JSONObject zzmJ() {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(this.zzXj)) {
                jSONObject.put(UnityAdsConstants.UNITY_ADS_ANALYTICS_QUERYPARAM_PROVIDERID_KEY, this.zzXj);
            }
