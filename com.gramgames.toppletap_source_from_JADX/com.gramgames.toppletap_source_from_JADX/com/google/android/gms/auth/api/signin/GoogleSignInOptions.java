...
public class GoogleSignInOptions implements Optional, SafeParcelable {
    ...
    public static final class Builder {
        ...
        public GoogleSignInOptions build() {
            ...
            return new GoogleSignInOptions(this.zzTI, this.zzXa, this.zzXb, this.zzXc, this.zzXd, this.zzXe, null);
        }
        ...
        public Builder setAccountName(String accountName) {
            this.zzTI = new Account(zzx.zzcM(accountName), GoogleAuthUtil.GOOGLE_ACCOUNT_TYPE);
            return this;
        }
