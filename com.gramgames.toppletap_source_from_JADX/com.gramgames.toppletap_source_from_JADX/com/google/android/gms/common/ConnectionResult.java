...
public final class ConnectionResult implements SafeParcelable {
    ...
    public String toString() {
        return zzw.zzy(this).zzg("statusCode", getStatusString(this.zzade)).zzg("resolution", this.mPendingIntent).zzg(ShareConstants.WEB_DIALOG_PARAM_MESSAGE, this.zzafC).toString();
    }
