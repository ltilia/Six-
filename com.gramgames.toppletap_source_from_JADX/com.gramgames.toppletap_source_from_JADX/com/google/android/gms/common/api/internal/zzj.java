...
public final class zzj extends GoogleApiClient implements com.google.android.gms.common.api.internal.zzp.zza {
    ...
    class 1 implements zzd {
        ...
        1(zzj com_google_android_gms_common_api_internal_zzj) {
    ...
    class 2 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzj zzaid;

        2(zzj com_google_android_gms_common_api_internal_zzj) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
        }
    ...
    class 3 implements ConnectionCallbacks {
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ AtomicReference zzaie;
        final /* synthetic */ zzv zzaif;

        3(zzj com_google_android_gms_common_api_internal_zzj, AtomicReference atomicReference, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaie = atomicReference;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
        }

        public void onConnected(Bundle connectionHint) {
            this.zzaid.zza((GoogleApiClient) this.zzaie.get(), this.zzaif, true);
        }
    ...
    class 4 implements OnConnectionFailedListener {
        ...
        4(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
        }
    ...
    class 5 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzabL;
        final /* synthetic */ zzj zzaid;
        final /* synthetic */ zzv zzaif;
        final /* synthetic */ boolean zzaig;

        5(zzj com_google_android_gms_common_api_internal_zzj, zzv com_google_android_gms_common_api_internal_zzv, boolean z, GoogleApiClient googleApiClient) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
            this.zzaif = com_google_android_gms_common_api_internal_zzv;
            this.zzaig = z;
    ...
    class 6 implements Runnable {
        ...
        6(zzj com_google_android_gms_common_api_internal_zzj, FragmentActivity fragmentActivity) {
            this.zzaid = com_google_android_gms_common_api_internal_zzj;
        ...
        public void run() {
            if (!this.zzaih.isFinishing() && !this.zzaih.getSupportFragmentManager().isDestroyed()) {
                zzw.zzb(this.zzaih).zzbD(this.zzaid.zzagp);
            }
        }
    }
    ...
    public zzj(Context context, Lock lock, Looper looper, zzf com_google_android_gms_common_internal_zzf, com.google.android.gms.common.zzc com_google_android_gms_common_zzc, com.google.android.gms.common.api.Api.zza<? extends zzrn, zzro> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzrn__com_google_android_gms_internal_zzro, Map<Api<?>, Integer> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<com.google.android.gms.common.api.Api.zzc<?>, com.google.android.gms.common.api.Api.zzb> map2, int i, int i2, ArrayList<zzc> arrayList) {
        this.zzahM = null;
        this.zzahN = new LinkedList();
        this.zzahP = 120000;
        this.zzahQ = HlsChunkSource.DEFAULT_MIN_BUFFER_TO_SWITCH_UP_MS;
        this.zzahU = new HashSet();
        this.zzahV = Collections.newSetFromMap(new WeakHashMap());
        this.zzahW = Collections.newSetFromMap(new ConcurrentHashMap(16, AdaptiveEvaluator.DEFAULT_BANDWIDTH_FRACTION, 2));
        this.zzahZ = null;
        this.zzaia = null;
        this.zzaib = new 1(this);
        this.zzaic = new 2(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzv com_google_android_gms_common_api_internal_zzv, boolean z) {
        zzmf.zzamA.zzf(googleApiClient).setResultCallback(new 5(this, com_google_android_gms_common_api_internal_zzv, z, googleApiClient));
    }
    ...
    private static void zza(zze<?> com_google_android_gms_common_api_internal_zzj_zze_, com.google.android.gms.common.api.zza com_google_android_gms_common_api_zza, IBinder iBinder) {
        if (com_google_android_gms_common_api_internal_zzj_zze_.isReady()) {
            com_google_android_gms_common_api_internal_zzj_zze_.zza(new zzb(com_google_android_gms_common_api_zza, iBinder, null));
            ...
            Object com_google_android_gms_common_api_internal_zzj_zzb = new zzb(com_google_android_gms_common_api_zza, iBinder, null);
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        zzv com_google_android_gms_common_api_internal_zzv = new zzv((GoogleApiClient) this);
        if (this.zzahT.containsKey(zzmf.zzUI)) {
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzmf.API).addConnectionCallbacks(new 3(this, atomicReference, com_google_android_gms_common_api_internal_zzv)).addOnConnectionFailedListener(new 4(this, com_google_android_gms_common_api_internal_zzv)).setHandler(this.zzahR).build();
    ...
    public void stopAutoManage(@NonNull FragmentActivity lifecycleActivity) {
        if (this.zzagp >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new 6(this, lifecycleActivity));
                return;
            } else {
                zza.zzbD(this.zzagp);
                return;
