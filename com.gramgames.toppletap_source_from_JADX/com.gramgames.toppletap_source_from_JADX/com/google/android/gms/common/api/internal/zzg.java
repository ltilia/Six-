...
public class zzg implements zzk {
    ...
    class 1 extends zza {
        ...
        1(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
    ...
    class 2 extends zza {
        ...
        2(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
            this.zzahl = com_google_android_gms_common_api_internal_zzg;
            super(com_google_android_gms_common_api_internal_zzk);
        }
    ...
    public void connect() {
        if (this.zzahk) {
            this.zzahk = false;
            this.zzahj.zza(new 2(this, this));
        }
    }
    ...
    public <A extends zzb, T extends zza<? extends Result, A>> T zzb(T t) {
        try {
            ...
            this.zzahj.zza(new 1(this, this));
        }
        return t;
    }
