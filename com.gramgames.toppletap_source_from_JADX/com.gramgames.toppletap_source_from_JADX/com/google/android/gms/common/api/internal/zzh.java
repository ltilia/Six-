...
public class zzh implements zzk {
    ...
    class 1 implements Runnable {
        ...
        1(zzh com_google_android_gms_common_api_internal_zzh) {
    ...
    private class zzb extends zzf {
        ...
        class 1 extends zza {
            final /* synthetic */ ConnectionResult zzahF;
            final /* synthetic */ zzb zzahG;

            1(zzb com_google_android_gms_common_api_internal_zzh_zzb, zzk com_google_android_gms_common_api_internal_zzk, ConnectionResult connectionResult) {
                this.zzahG = com_google_android_gms_common_api_internal_zzh_zzb;
                this.zzahF = connectionResult;
                super(com_google_android_gms_common_api_internal_zzk);
            }

            public void zzpt() {
                this.zzahG.zzahC.zzg(this.zzahF);
            }
        }
        ...
        public void zzpt() {
            ...
            if (isGooglePlayServicesAvailable != 0) {
                this.zzahC.zzahj.zza(new 1(this, this.zzahC, new ConnectionResult(isGooglePlayServicesAvailable, null)));
                return;
            }
            if (this.zzahC.zzahu) {
    ...
    private static class zzd extends com.google.android.gms.signin.internal.zzb {
        ...
        class 1 extends zza {
            final /* synthetic */ zzh zzahI;
            final /* synthetic */ SignInResponse zzahJ;
            final /* synthetic */ zzd zzahK;

            1(zzd com_google_android_gms_common_api_internal_zzh_zzd, zzk com_google_android_gms_common_api_internal_zzk, zzh com_google_android_gms_common_api_internal_zzh, SignInResponse signInResponse) {
                this.zzahK = com_google_android_gms_common_api_internal_zzh_zzd;
                this.zzahI = com_google_android_gms_common_api_internal_zzh;
                this.zzahJ = signInResponse;
                super(com_google_android_gms_common_api_internal_zzk);
            }

            public void zzpt() {
                this.zzahI.zza(this.zzahJ);
            }
        }
        ...
        public void zzb(SignInResponse signInResponse) {
            zzh com_google_android_gms_common_api_internal_zzh = (zzh) this.zzahD.get();
            if (com_google_android_gms_common_api_internal_zzh != null) {
                com_google_android_gms_common_api_internal_zzh.zzahj.zza(new 1(this, com_google_android_gms_common_api_internal_zzh, com_google_android_gms_common_api_internal_zzh, signInResponse));
            }
        }
    }
