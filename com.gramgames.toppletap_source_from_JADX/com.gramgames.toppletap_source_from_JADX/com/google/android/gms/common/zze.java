...
public class zze {
    ...
    public static String getOpenSourceSoftwareLicenseInfo(Context context) {
        ...
        try {
            openInputStream = context.getContentResolver().openInputStream(new Builder().scheme("android.resource").authority(GOOGLE_PLAY_SERVICES_PACKAGE).appendPath(NotificationReciever.RAW_TYPE).appendPath("oss_notice").build());
        ...
        if (!zzafR.get()) {
            ...
            synchronized (zzqy) {
                if (zzafO == null) {
                    ...
                    try {
                        Bundle bundle = context.getPackageManager().getApplicationInfo(context.getPackageName(), RadialCountdown.BACKGROUND_ALPHA).metaData;
                        if (bundle != null) {
