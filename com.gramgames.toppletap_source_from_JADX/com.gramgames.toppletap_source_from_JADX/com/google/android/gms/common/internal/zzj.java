...
public abstract class zzj<T extends IInterface> implements com.google.android.gms.common.api.Api.zzb, com.google.android.gms.common.internal.zzk.zza {
    ...
    L_0x000b:
        ...
        r1 = r4.zzpV;
        monitor-enter(r1);
        r4.zzalE = r5;	 Catch:{ all -> 0x0027 }
        r4.zzalB = r6;	 Catch:{ all -> 0x0027 }
    ...
    public final Account zzqq() {
        return this.zzTI != null ? this.zzTI : new Account("<<default account>>", GoogleAuthUtil.GOOGLE_ACCOUNT_TYPE);
    }
}
