        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case Yytoken.TYPE_RIGHT_BRACE /*2*/:
                    data.enforceInterface("com.google.android.gms.common.internal.ISignInButtonCreator");
                    zza = zza(com.google.android.gms.dynamic.zzd.zza.zzbs(data.readStrongBinder()), data.readInt() != 0 ? (SignInButtonConfig) SignInButtonConfig.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    if (zza != null) {
