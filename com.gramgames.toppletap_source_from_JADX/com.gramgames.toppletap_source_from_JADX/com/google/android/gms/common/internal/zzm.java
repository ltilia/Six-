...
final class zzm extends zzl implements Callback {
    ...
    private static final class zza {
        ...
        public Intent zzqS() {
            return this.zzSU != null ? new Intent(this.zzSU).setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE) : new Intent().setComponent(this.zzamc);
        }
    }
    ...
    zzm(Context context) {
        ...
        this.zzamb = HlsChunkSource.DEFAULT_MIN_BUFFER_TO_SWITCH_UP_MS;
    }
