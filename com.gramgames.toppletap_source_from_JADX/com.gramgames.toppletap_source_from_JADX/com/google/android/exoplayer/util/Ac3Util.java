...
public final class Ac3Util {
    ...
    static {
        ...
        BITRATE_BY_HALF_FRMSIZECOD = new int[]{32, 40, 48, 56, 64, 80, 96, 112, RadialCountdown.BACKGROUND_ALPHA, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AUDIO_SAMPLES_PER_AUDIO_BLOCK, 320, 384, 448, AdRequest.MAX_CONTENT_URL_LENGTH, 576, 640};
        SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = new int[]{69, 87, R.styleable.Theme_editTextStyle, 121, 139, 174, 208, 243, 278, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    }
    ...
    public static int parseEAc3SyncframeSize(byte[] data) {
        return ((((data[2] & 7) << 8) + (data[3] & RadialCountdown.PROGRESS_ALPHA)) + 1) * 2;
    }
