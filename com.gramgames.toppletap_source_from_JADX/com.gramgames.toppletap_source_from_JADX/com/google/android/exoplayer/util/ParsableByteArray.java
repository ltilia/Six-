...
public final class ParsableByteArray {
    ...
    public int readUnsignedByte() {
        ...
        int i = this.position;
        this.position = i + 1;
        return bArr[i] & RadialCountdown.PROGRESS_ALPHA;
    }
    ...
    public int readUnsignedShort() {
        ...
        int i = this.position;
        this.position = i + 1;
        int i2 = (bArr[i] & RadialCountdown.PROGRESS_ALPHA) << 8;
        byte[] bArr2 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        return i2 | (bArr2[i3] & RadialCountdown.PROGRESS_ALPHA);
    }
    ...
    public int readLittleEndianUnsignedShort() {
        ...
        int i = this.position;
        this.position = i + 1;
        int i2 = bArr[i] & RadialCountdown.PROGRESS_ALPHA;
        byte[] bArr2 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        return i2 | ((bArr2[i3] & RadialCountdown.PROGRESS_ALPHA) << 8);
    }
    ...
    public short readShort() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        return (short) (i2 | (bArr2[i3] & RadialCountdown.PROGRESS_ALPHA));
    }
    ...
    public short readLittleEndianShort() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        return (short) (i2 | ((bArr2[i3] & RadialCountdown.PROGRESS_ALPHA) << 8));
    }
    ...
    public int readUnsignedInt24() {
        ...
        int i = this.position;
        this.position = i + 1;
        int i2 = (bArr[i] & RadialCountdown.PROGRESS_ALPHA) << 16;
        byte[] bArr2 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        i2 |= (bArr2[i3] & RadialCountdown.PROGRESS_ALPHA) << 8;
        bArr2 = this.data;
        i3 = this.position;
        this.position = i3 + 1;
        return i2 | (bArr2[i3] & RadialCountdown.PROGRESS_ALPHA);
    ...
    public int readLittleEndianUnsignedInt24() {
        ...
        i3 = this.position;
        this.position = i3 + 1;
        return i2 | ((bArr2[i3] & RadialCountdown.PROGRESS_ALPHA) << 16);
    }
    ...
    public int readInt() {
        ...
        int i = this.position;
        this.position = i + 1;
        int i2 = (bArr[i] & RadialCountdown.PROGRESS_ALPHA) << 24;
        byte[] bArr2 = this.data;
        int i3 = this.position;
        this.position = i3 + 1;
        i2 |= (bArr2[i3] & RadialCountdown.PROGRESS_ALPHA) << 16;
        bArr2 = this.data;
        i3 = this.position;
        this.position = i3 + 1;
        i2 |= (bArr2[i3] & RadialCountdown.PROGRESS_ALPHA) << 8;
    ...
    public int readLittleEndianInt() {
        ...
        i3 = this.position;
        this.position = i3 + 1;
        return i2 | ((bArr2[i3] & RadialCountdown.PROGRESS_ALPHA) << 24);
    }
    ...
    public int readUnsignedFixedPoint1616() {
        ...
        int i3 = this.position;
        this.position = i3 + 1;
        int result = i2 | (bArr2[i3] & RadialCountdown.PROGRESS_ALPHA);
        this.position += 2;
        return result;
    }
