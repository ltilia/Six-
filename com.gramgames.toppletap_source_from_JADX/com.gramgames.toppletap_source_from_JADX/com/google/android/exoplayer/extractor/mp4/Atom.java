...
abstract class Atom {
    ...
    static {
        ...
        TYPE_name = Util.getIntegerCodeForString(UnityAdsConstants.UNITY_ADS_ZONE_NAME_KEY);
        TYPE_data = Util.getIntegerCodeForString(UnityAdsConstants.UNITY_ADS_JSON_DATA_ROOTKEY);
    ...
    public static int parseFullAtomVersion(int fullAtomInt) {
        return (fullAtomInt >> 24) & RadialCountdown.PROGRESS_ALPHA;
    }
    ...
    public static String getAtomTypeString(int type) {
        return BuildConfig.FLAVOR + ((char) (type >> 24)) + ((char) ((type >> LONG_HEADER_SIZE) & RadialCountdown.PROGRESS_ALPHA)) + ((char) ((type >> HEADER_SIZE) & RadialCountdown.PROGRESS_ALPHA)) + ((char) (type & RadialCountdown.PROGRESS_ALPHA));
    }
}
