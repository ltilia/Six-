...
public final class AdSize {
    ...
    public boolean isSizeAppropriate(int width, int height) {
        ...
        return ((float) width) <= ((float) width2) * 1.25f && ((float) width) >= ((float) width2) * DefaultLoadControl.DEFAULT_HIGH_BUFFER_LOAD && ((float) height) <= ((float) height2) * 1.25f && ((float) height) >= ((float) height2) * DefaultLoadControl.DEFAULT_HIGH_BUFFER_LOAD;
    }
