...
public final class iy implements MembersInjector<Factory> {
    ...
    private iy(Provider<CallToActionOverlay.Factory> provider, Provider<ThirdPartyAdTracking.Factory> provider2) {
        if (a || provider != null) {
            this.b = provider;
            if (a || provider2 != null) {
                this.c = provider2;
    ...
    public static MembersInjector<Factory> a(Provider<CallToActionOverlay.Factory> provider, Provider<ThirdPartyAdTracking.Factory> provider2) {
        return new iy(provider, provider2);
    }
}
