...
final class u implements UncaughtExceptionHandler {
    ...
    final synchronized boolean a() {
        boolean z;
        u defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
