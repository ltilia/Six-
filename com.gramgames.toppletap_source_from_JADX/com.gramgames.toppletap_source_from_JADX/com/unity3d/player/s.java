...
public final class s extends Dialog implements TextWatcher, OnClickListener {
    ...
    class 2 extends EditText {
        final /* synthetic */ s a;

        2(s sVar, Context context) {
            this.a = sVar;
            super(context);
        }
    ...
    class 3 implements OnEditorActionListener {
        final /* synthetic */ s a;
    ...
    public s(Context context, UnityPlayer unityPlayer, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        ...
        editText.setOnFocusChangeListener(new 1(this));
    }

    private static int a(int i, boolean z, boolean z2, boolean z3) {
        int i2 = 0;
        int i3 = (z2 ? MetadataChangeSet.INDEXABLE_TEXT_SIZE_LIMIT_BYTES : 0) | (z ? AccessibilityNodeInfoCompat.ACTION_PASTE : 0);
        if (z3) {
            i2 = RadialCountdown.BACKGROUND_ALPHA;
        }
        i2 |= i3;
    ...
    protected final View createSoftInputView() {
        ...
        View 2 = new 2(this, this.a);
        LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(15);
        layoutParams.addRule(0, 1057292290);
        2.setLayoutParams(layoutParams);
        2.setId(1057292289);
        relativeLayout.addView(2);
        2 = new Button(this.a);
        2.setText(this.a.getResources().getIdentifier("ok", "string", "android"));
        ...
        relativeLayout.addView(2);
        ((EditText) relativeLayout.findViewById(1057292289)).setOnEditorActionListener(new 3(this));
