...
class HtmlWebViewClient extends WebViewClient {
    ...
    private final EnumSet<UrlAction> SUPPORTED_URL_ACTIONS;
    ...
    class 1 implements MoPubSchemeListener {
        1() {
        }
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        new Builder().withDspCreativeId(this.mDspCreativeId).withSupportedUrlActions(this.SUPPORTED_URL_ACTIONS).withResultActions(new 2()).withMoPubSchemeListener(new 1()).build().handleUrl(this.mContext, url, this.mHtmlWebView.wasClicked());
        return true;
    }
