...
public class XmlUtils {
    ...
    static class 1 implements NodeProcessor<String> {
        1() {
        }
    ...
    static class 2 implements NodeProcessor<String> {
        2() {
        }
    ...
    static class 3 implements NodeProcessor<Node> {
        3() {
        }
    ...
    public static String getFirstMatchingStringData(Document vastDoc, String elementName, String attributeName, String attributeValue) {
        return (String) getFirstMatchFromDocument(vastDoc, elementName, attributeName, attributeValue, new 1());
    }
    ...
    public static List<String> getStringDataAsList(Document vastDoc, String elementName, String attributeName, String attributeValue) {
        return getListFromDocument(vastDoc, elementName, attributeName, attributeValue, new 2());
    }
    ...
    public static List<Node> getNodesWithElementAndAttribute(Document vastDoc, String elementName, String attributeName, String attributeValue) {
        return getListFromDocument(vastDoc, elementName, attributeName, attributeValue, new 3());
    }
}
