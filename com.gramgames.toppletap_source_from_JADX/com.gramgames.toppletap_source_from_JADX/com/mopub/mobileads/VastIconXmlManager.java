...
public class VastIconXmlManager {
    ...
    Integer getOffsetMS() {
        ...
        try {
            ...
            MoPubLog.d(String.format("Invalid VAST icon offset format: %s:", new Object[]{iconOffsetStr}));
        }
        return iconOffset;
    }
    ...
    Integer getDurationMS() {
        ...
        try {
            ...
            MoPubLog.d(String.format("Invalid VAST icon duration format: %s:", new Object[]{iconDurationStr}));
        }
        return iconDuration;
    }
