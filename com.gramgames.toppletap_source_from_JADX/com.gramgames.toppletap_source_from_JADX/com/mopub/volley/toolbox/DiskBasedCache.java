...
public class DiskBasedCache implements Cache {
    ...
    L_0x0011:
        ...
        com.mopub.volley.VolleyLog.e(r9, r10);	 Catch:{ all -> 0x006e }
    L_0x0022:
        monitor-exit(r13);
        return;
    L_0x0024:
    ...
    L_0x0031:
        ...
        r2 = com.mopub.volley.toolbox.DiskBasedCache.CacheHeader.readHeader(r6);	 Catch:{ IOException -> 0x0076, all -> 0x0073 }
    ...
    static void writeInt(OutputStream os, int n) throws IOException {
        os.write((n >> 0) & RadialCountdown.PROGRESS_ALPHA);
        os.write((n >> 8) & RadialCountdown.PROGRESS_ALPHA);
        os.write((n >> 16) & RadialCountdown.PROGRESS_ALPHA);
        os.write((n >> 24) & RadialCountdown.PROGRESS_ALPHA);
    }
    ...
    static void writeString(OutputStream os, String s) throws IOException {
        byte[] b = s.getBytes(C.UTF8_NAME);
        writeLong(os, (long) b.length);
        os.write(b, 0, b.length);
    }

    static String readString(InputStream is) throws IOException {
        return new String(streamToBytes(is, (int) readLong(is)), C.UTF8_NAME);
    }
