...
public class NetworkImageView extends ImageView {
    ...
    class 1 implements ImageListener {
        ...
        class 1 implements Runnable {
            ...
            1(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                1.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new 1(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new 1(isInLayoutPass), maxWidth, maxHeight);
        }
    }
