...
public abstract class StaticNativeAd extends BaseNativeAd implements ImpressionInterface, ClickInterface {
    ...
    public StaticNativeAd() {
        this.mImpressionMinTimeViewed = AdError.NETWORK_ERROR_CODE;
    ...
    public final void setStarRating(@Nullable Double starRating) {
        if (starRating == null) {
            ...
            MoPubLog.d("Ignoring attempt to set invalid star rating (" + starRating + "). Must be " + "between " + 0.0d + " and " + MAX_STAR_RATING + ".");
        } else {
