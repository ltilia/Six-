...
public class FacebookAdRenderer implements MoPubAdRenderer<FacebookVideoEnabledNativeAd> {
    ...
    public View createAdView(Activity activity, ViewGroup parent) {
        View adView = LayoutInflater.from(activity).inflate(this.mViewBinder.layoutId, parent, false);
        ...
        if (mainImageView != null) {
            ...
            ViewGroup mainImageParent = (ViewGroup) mainImageView.getParent();
            mainImageParent.addView(new MediaView(activity), mainImageParent.indexOfChild(mainImageView) + 1, mediaViewLayoutParams);
        }
        return adView;
    }
