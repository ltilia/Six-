...
class MraidBanner extends CustomEventBanner {
    ...
    class 1 implements MraidListener {
        1() {
        }
    ...
    protected void loadBanner(@NonNull Context context, @NonNull CustomEventBannerListener customEventBannerListener, @NonNull Map<String, Object> localExtras, @NonNull Map<String, String> serverExtras) {
        ...
        if (extrasAreValid(serverExtras)) {
            ...
            try {
                ...
                this.mMraidController.setMraidListener(new 1());
