...
public class MraidVideoViewController extends BaseVideoViewController {
    ...
    class 1 implements OnCompletionListener {
        1() {
        }
    ...
    class 2 implements OnErrorListener {
        2() {
        }
    ...
    public MraidVideoViewController(Context context, Bundle intentExtras, Bundle savedInstanceState, BaseVideoViewControllerListener baseVideoViewControllerListener) {
        ...
        this.mVideoView.setOnCompletionListener(new 1());
        this.mVideoView.setOnErrorListener(new 2());
    ...
    private void createInterstitialCloseButton() {
        ...
        this.mCloseButton.setOnClickListener(new 3());
