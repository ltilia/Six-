...
public class ManifestUtils {
    ...
    private static FlagCheckUtil sFlagCheckUtil;
    ...
    static {
        sFlagCheckUtil = new FlagCheckUtil();
    ...
    private static ActivityConfigChanges getActivityConfigChanges(@NonNull Context context, @NonNull Class<? extends Activity> activity) throws NameNotFoundException {
        ...
        activityConfigChanges.hasOrientation = sFlagCheckUtil.hasFlag(activity, activityInfo.configChanges, RadialCountdown.BACKGROUND_ALPHA);
        ...
        if (VersionCode.currentApiLevel().isAtLeast(VersionCode.HONEYCOMB_MR2) && context.getApplicationInfo().targetSdkVersion >= VersionCode.HONEYCOMB_MR2.getApiLevel()) {
            activityConfigChanges.hasScreenSize = sFlagCheckUtil.hasFlag(activity, activityInfo.configChanges, AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT);
        }
