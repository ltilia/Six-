...
public enum UrlAction {
    HANDLE_MOPUB_SCHEME(false) {
        ...
        protected void performAction(@NonNull Context context, @NonNull Uri uri, @NonNull UrlHandler urlHandler, @Nullable String creativeId) throws IntentNotResolvableException {
            ...
            } else if (UnityAdsConstants.UNITY_ADS_WEBVIEW_API_CLOSE.equalsIgnoreCase(host)) {
    ...
    HANDLE_PHONE_SCHEME(true) {
        public boolean shouldTryHandlingUrl(@NonNull Uri uri) {
            ...
            return AdWebViewClient.TELEPHONE.equalsIgnoreCase(scheme) || AdWebViewClient.VOICEMAIL.equalsIgnoreCase(scheme) || AdWebViewClient.SMS.equalsIgnoreCase(scheme) || AdWebViewClient.MAILTO.equalsIgnoreCase(scheme) || AdWebViewClient.GEO.equalsIgnoreCase(scheme) || AdWebViewClient.GOOGLE_STREETVIEW.equalsIgnoreCase(scheme);
        }
