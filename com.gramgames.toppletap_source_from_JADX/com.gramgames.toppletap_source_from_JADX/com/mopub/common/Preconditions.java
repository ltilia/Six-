...
public final class Preconditions {
    ...
    public static final class NoThrow {
        ...
        public static boolean checkArgument(boolean expression) {
            return Preconditions.checkArgumentInternal(expression, sStrictMode, "Illegal argument", Preconditions.EMPTY_ARGUMENTS);
        }

        public static boolean checkArgument(boolean expression, String errorMessage) {
            return Preconditions.checkArgumentInternal(expression, sStrictMode, errorMessage, Preconditions.EMPTY_ARGUMENTS);
        }
        ...
        public static boolean checkState(boolean expression) {
            return Preconditions.checkStateInternal(expression, sStrictMode, "Illegal state.", Preconditions.EMPTY_ARGUMENTS);
        }

        public static boolean checkState(boolean expression, String errorMessage) {
            return Preconditions.checkStateInternal(expression, sStrictMode, errorMessage, Preconditions.EMPTY_ARGUMENTS);
        }
        ...
        public static boolean checkNotNull(Object reference) {
            return Preconditions.checkNotNullInternal(reference, sStrictMode, "Object can not be null.", Preconditions.EMPTY_ARGUMENTS);
        }

        public static boolean checkNotNull(Object reference, String errorMessage) {
            return Preconditions.checkNotNullInternal(reference, sStrictMode, errorMessage, Preconditions.EMPTY_ARGUMENTS);
        }
        ...
        public static boolean checkUiThread() {
            return Preconditions.checkUiThreadInternal(sStrictMode, "This method must be called from the UI thread.", Preconditions.EMPTY_ARGUMENTS);
        }

        public static boolean checkUiThread(String errorMessage) {
            return Preconditions.checkUiThreadInternal(sStrictMode, errorMessage, Preconditions.EMPTY_ARGUMENTS);
        }
    ...
    public static void checkUiThread() {
        checkUiThreadInternal(true, "This method must be called from the UI thread.", EMPTY_ARGUMENTS);
    }
