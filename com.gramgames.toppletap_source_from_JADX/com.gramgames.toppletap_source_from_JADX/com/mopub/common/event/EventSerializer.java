...
public class EventSerializer {
    ...
    public JSONObject serializeAsJson(@NonNull BaseEvent event) throws JSONException {
        ...
        jsonObject.put(UnityAdsConstants.UNITY_ADS_ZONE_NAME_KEY, event.getName().getName());
        ...
        jsonObject.put(str, obj);
        jsonObject.put(NativeProtocol.BRIDGE_ARG_APP_NAME_STRING, event.getAppName());
        ...
        MoPubNetworkType moPubNetworkType = event.getNetworkType();
