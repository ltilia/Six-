...
public abstract class BaseUrlGenerator {
    ...
    protected void setExternalStoragePermission(boolean isExternalStoragePermissionGranted) {
        addParam("android_perms_ext_storage", isExternalStoragePermissionGranted ? AppEventsConstants.EVENT_PARAM_VALUE_YES : AppEventsConstants.EVENT_PARAM_VALUE_NO);
    }
    ...
    protected void setDeviceDimensions(@NonNull Point dimensions) {
        addParam(WIDTH_KEY, BuildConfig.FLAVOR + dimensions.x);
        addParam(HEIGHT_KEY, BuildConfig.FLAVOR + dimensions.y);
    }
}
