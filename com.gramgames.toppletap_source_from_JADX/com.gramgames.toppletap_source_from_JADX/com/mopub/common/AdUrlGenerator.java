...
public abstract class AdUrlGenerator extends BaseUrlGenerator {
    ...
    protected void setDensity(float density) {
        addParam(SCREEN_SCALE_KEY, BuildConfig.FLAVOR + density);
    }
    ...
    protected void setMccCode(String networkOperator) {
        addParam(MOBILE_COUNTRY_CODE_KEY, networkOperator == null ? BuildConfig.FLAVOR : networkOperator.substring(0, mncPortionLength(networkOperator)));
    }

    protected void setMncCode(String networkOperator) {
        addParam(MOBILE_NETWORK_CODE_KEY, networkOperator == null ? BuildConfig.FLAVOR : networkOperator.substring(mncPortionLength(networkOperator)));
    }
