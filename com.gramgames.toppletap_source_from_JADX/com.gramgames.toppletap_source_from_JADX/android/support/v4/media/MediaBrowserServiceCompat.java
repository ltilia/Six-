...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class 3 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        3(Object x0, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class 4 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        4(Object x0, ResultReceiver resultReceiver) {
    ...
    private class ServiceImpl {
        ...
        class 1 implements Runnable {
            ...
            1(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class 2 implements Runnable {
            ...
            2(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class 3 implements Runnable {
            ...
            3(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class 4 implements Runnable {
            ...
            4(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class 5 implements Runnable {
            ...
            5(String str, ResultReceiver resultReceiver) {
        ...
        class 6 implements Runnable {
            ...
            6(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class 7 implements Runnable {
            ...
            7(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new 1(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new 2(callbacks));
        }

        public void addSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new 3(callbacks, id, options));
        }

        public void removeSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new 4(callbacks, id, options));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new 5(mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new 6(callbacks));
        }

        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new 7(callbacks));
        }
    }
    ...
    private class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class 1 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            1(Handler x0, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String mediaId, ItemCallback cb) {
            this.mServiceImpl.getMediaItem(mediaId, new 1(MediaBrowserServiceCompat.this.mHandler, cb));
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new 1(token));
        }
    }
    ...
    private void notifyChildrenChangedInternal(String parentId, Bundle options) {
        ...
        this.mHandler.post(new 2(parentId, options));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new 3(parentId, connection, parentId, options);
        if (options == null) {
            onLoadChildren(parentId, result);
        } else {
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new 4(itemId, receiver);
