...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal {
        ...
        class 1 implements Runnable {
            ...
            1(ItemCallback itemCallback, String str) {
        ...
        class 3 implements Runnable {
            ...
            3(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                this.mHandler.post(new 1(cb, mediaId));
            } else if (this.mServiceBinderWrapper == null) {
                this.mHandler.post(new 2(cb));
            } else {
                try {
                    ...
                    this.mHandler.post(new 3(cb, mediaId));
                }
            }
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        class 1 implements Runnable {
            ...
            1(ServiceConnection serviceConnection) {
        ...
        class 2 implements Runnable {
            ...
            2(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            class 1 implements Runnable {
                ...
                1(ComponentName componentName, IBinder iBinder) {
            ...
            public void onServiceConnected(ComponentName name, IBinder binder) {
                postOrRun(new 1(name, binder));
            }

            public void onServiceDisconnected(ComponentName name) {
                postOrRun(new 2(name));
            }
        ...
        public void connect() {
            if (this.mState != 0) {
                ...
                if (!bound) {
                    this.mHandler.post(new 1(thisConnection));
                }
            }
        }
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                Log.i(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
                this.mHandler.post(new 2(cb, mediaId));
            } else {
                try {
                    this.mServiceBinderWrapper.getMediaItem(mediaId, new ItemReceiver(mediaId, cb, this.mHandler));
                } catch (RemoteException e) {
    ...
    public static class MediaItem implements Parcelable {
        ...
        static class 1 implements Creator<MediaItem> {
            1() {
            }
