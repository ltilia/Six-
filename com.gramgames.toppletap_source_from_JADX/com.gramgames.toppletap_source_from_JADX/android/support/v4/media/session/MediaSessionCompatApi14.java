...
class MediaSessionCompatApi14 {
    ...
    public static void registerRemoteControlClient(Context context, Object rccObj) {
        ((AudioManager) context.getSystemService(MimeTypes.BASE_TYPE_AUDIO)).registerRemoteControlClient((RemoteControlClient) rccObj);
    }

    public static void unregisterRemoteControlClient(Context context, Object rccObj) {
        ((AudioManager) context.getSystemService(MimeTypes.BASE_TYPE_AUDIO)).unregisterRemoteControlClient((RemoteControlClient) rccObj);
    }
    ...
    static int getRccTransportControlFlagsFromActions(long actions) {
        ...
        if ((ACTION_SKIP_TO_NEXT & actions) != 0) {
            transportControlFlags |= RadialCountdown.BACKGROUND_ALPHA;
        }
