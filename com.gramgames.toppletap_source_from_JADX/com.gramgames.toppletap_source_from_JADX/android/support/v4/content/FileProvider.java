...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String authority) throws IOException, XmlPullParserException {
        ...
        XmlResourceParser in = context.getPackageManager().resolveContentProvider(authority, RadialCountdown.BACKGROUND_ALPHA).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
        if (in == null) {
