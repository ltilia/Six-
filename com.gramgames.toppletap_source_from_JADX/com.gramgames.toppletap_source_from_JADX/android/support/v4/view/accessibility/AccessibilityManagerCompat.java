...
public final class AccessibilityManagerCompat {
    ...
    static class AccessibilityManagerIcsImpl extends AccessibilityManagerStubImpl {
        ...
        class 1 implements AccessibilityStateChangeListenerBridge {
            final /* synthetic */ AccessibilityStateChangeListenerCompat val$listener;

            1(AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
        ...
        public Object newAccessiblityStateChangeListener(AccessibilityStateChangeListenerCompat listener) {
            return AccessibilityManagerCompatIcs.newAccessibilityStateChangeListener(new 1(listener));
        }
