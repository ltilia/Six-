...
public class AccessibilityNodeProviderCompat {
    ...
    static class AccessibilityNodeProviderJellyBeanImpl extends AccessibilityNodeProviderStubImpl {
        ...
        class 1 implements AccessibilityNodeInfoBridge {
            ...
            1(AccessibilityNodeProviderCompat accessibilityNodeProviderCompat) {
        ...
        public Object newAccessibilityNodeProviderBridge(AccessibilityNodeProviderCompat compat) {
            return AccessibilityNodeProviderCompatJellyBean.newAccessibilityNodeProviderBridge(new 1(compat));
        }
    }
    ...
    static class AccessibilityNodeProviderKitKatImpl extends AccessibilityNodeProviderStubImpl {
        ...
        public Object newAccessibilityNodeProviderBridge(AccessibilityNodeProviderCompat compat) {
            return AccessibilityNodeProviderCompatKitKat.newAccessibilityNodeProviderBridge(new 1(compat));
        }
    }
