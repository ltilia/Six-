...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mTabAlpha = RadialCountdown.PROGRESS_ALPHA;
    ...
    public void setBackgroundColor(@ColorInt int color) {
        ...
        if (!this.mDrawFullUnderlineSet) {
            this.mDrawFullUnderline = (CtaButton.BACKGROUND_COLOR & color) == 0;
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor(CtaButton.BACKGROUND_COLOR | (this.mIndicatorColor & ViewCompat.MEASURED_SIZE_MASK));
