...
public class ViewPager extends ViewGroup {
    ...
    static class 1 implements Comparator<ItemInfo> {
        1() {
        }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int widthMode = Cue.TYPE_UNSET;
                    int heightMode = Cue.TYPE_UNSET;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        int action = ev.getAction() & RadialCountdown.PROGRESS_ALPHA;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            if (this.mAdapter.getCount() != 0) {
                ...
                float x;
                switch (action & RadialCountdown.PROGRESS_ALPHA) {
                    case SCROLL_STATE_IDLE /*0*/:
                        this.mScroller.abortAnimation();
                        this.mPopulatePending = DEBUG;
                        populate();
