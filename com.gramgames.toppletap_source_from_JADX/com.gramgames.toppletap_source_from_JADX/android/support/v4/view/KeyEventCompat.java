...
public final class KeyEventCompat {
    ...
    static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public int normalizeMetaState(int metaState) {
            if ((metaState & PsExtractor.AUDIO_STREAM) != 0) {
                metaState |= 1;
            }
            if ((metaState & 48) != 0) {
                metaState |= 2;
        ...
        public boolean metaStateHasModifiers(int metaState, int modifiers) {
            if (metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(metaState) & META_MODIFIER_MASK, modifiers, 1, 64, RadialCountdown.BACKGROUND_ALPHA), modifiers, 2, 16, 32) == modifiers) {
                return true;
            }
            return false;
        }
