...
class SearchViewCompatHoneycomb {
    ...
    static class 1 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        1(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class 2 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        2(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
