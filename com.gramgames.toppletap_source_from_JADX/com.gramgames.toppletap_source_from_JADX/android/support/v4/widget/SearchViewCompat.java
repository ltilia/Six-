...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class 1 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListenerCompat val$listener;

            1(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class 2 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListenerCompat val$listener;

            2(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new 1(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new 2(listener));
        }
