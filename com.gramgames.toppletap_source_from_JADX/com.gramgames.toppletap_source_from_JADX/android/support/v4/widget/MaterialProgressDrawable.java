...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            if (this.mAlpha < RadialCountdown.PROGRESS_ALPHA) {
    ...
    public MaterialProgressDrawable(Context context, View parent) {
        ...
        iArr[LARGE] = CtaButton.BACKGROUND_COLOR;
        this.COLORS = iArr;
        this.mAnimators = new ArrayList();
        this.mCallback = new 3();
        this.mParent = parent;
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        int startA = (startInt >> 24) & RadialCountdown.PROGRESS_ALPHA;
        int startR = (startInt >> 16) & RadialCountdown.PROGRESS_ALPHA;
        int startG = (startInt >> 8) & RadialCountdown.PROGRESS_ALPHA;
        int startB = startInt & RadialCountdown.PROGRESS_ALPHA;
        int endInt = Integer.valueOf(endValue).intValue();
        return ((((((int) (((float) (((endInt >> 24) & RadialCountdown.PROGRESS_ALPHA) - startA)) * fraction)) + startA) << 24) | ((((int) (((float) (((endInt >> 16) & RadialCountdown.PROGRESS_ALPHA) - startR)) * fraction)) + startR) << 16)) | ((((int) (((float) (((endInt >> 8) & RadialCountdown.PROGRESS_ALPHA) - startG)) * fraction)) + startG) << 8)) | (((int) (((float) ((endInt & RadialCountdown.PROGRESS_ALPHA) - startB)) * fraction)) + startB);
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new 1(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new 2(ring));
