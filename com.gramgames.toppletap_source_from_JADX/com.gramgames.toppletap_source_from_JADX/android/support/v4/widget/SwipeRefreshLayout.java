...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void createProgressView() {
        this.mCircleView = new CircleImageView(getContext(), CIRCLE_BG_LIGHT, CloseButton.TEXT_SIZE_SP);
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new 4(startingAlpha, endingAlpha);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case LARGE /*0*/:
                ...
                if (initialDownY != PlayerStats.UNSET_VALUE) {
    ...
    private float getMotionEventY(MotionEvent ev, int activePointerId) {
        ...
        if (index < 0) {
            return PlayerStats.UNSET_VALUE;
        }
