...
public class ViewDragHelper {
    ...
    static class 1 implements Interpolator {
        1() {
        }
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(AdError.NETWORK_ERROR_CODE, this.mMaxVelocity);
