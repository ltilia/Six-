...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    static {
        ...
        INVALID_PARENT_BOUNDS = new Rect(MoPubClientPositioning.NO_REPEAT, MoPubClientPositioning.NO_REPEAT, INVALID_ID, INVALID_ID);
    }
    ...
    private void updateHoveredVirtualView(int virtualViewId) {
        if (this.mHoveredVirtualViewId != virtualViewId) {
            ...
            sendEventForVirtualView(virtualViewId, RadialCountdown.BACKGROUND_ALPHA);
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int virtualViewId) {
        ...
        if ((actions & 64) != 0) {
        ...
        } else if ((actions & RadialCountdown.BACKGROUND_ALPHA) != 0) {
            ...
            if (this.mFocusedVirtualViewId == virtualViewId) {
                ...
                node.addAction((int) RadialCountdown.BACKGROUND_ALPHA);
            } else {
    ...
    private boolean requestAccessibilityFocus(int virtualViewId) {
        ...
        if (this.mFocusedVirtualViewId != INVALID_ID) {
            sendEventForVirtualView(this.mFocusedVirtualViewId, ExecutionOptions.MAX_TRACKING_TAG_STRING_LENGTH);
        }
