...
class TextToSpeechICSMR1 {
    ...
    static class 1 extends UtteranceProgressListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        1(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
    ...
    static class 2 implements OnUtteranceCompletedListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;

        2(UtteranceProgressListenerICSMR1 utteranceProgressListenerICSMR1) {
            this.val$listener = utteranceProgressListenerICSMR1;
        }
    ...
    static void setUtteranceProgressListener(TextToSpeech tts, UtteranceProgressListenerICSMR1 listener) {
        if (VERSION.SDK_INT >= 15) {
            tts.setOnUtteranceProgressListener(new 1(listener));
        } else {
            tts.setOnUtteranceCompletedListener(new 2(listener));
        }
    }
}
