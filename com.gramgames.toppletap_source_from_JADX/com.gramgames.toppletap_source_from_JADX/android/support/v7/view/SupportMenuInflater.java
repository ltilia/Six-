...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            ...
            this.groupId = a.getResourceId(R.styleable.MenuGroup_android_id, defaultItemOrder);
            this.groupCategory = a.getInt(R.styleable.MenuGroup_android_menuCategory, defaultItemOrder);
            this.groupOrder = a.getInt(R.styleable.MenuGroup_android_orderInCategory, defaultItemOrder);
            this.groupCheckable = a.getInt(R.styleable.MenuGroup_android_checkableBehavior, defaultItemOrder);
            this.groupVisible = a.getBoolean(R.styleable.MenuGroup_android_visible, defaultItemVisible);
            this.groupEnabled = a.getBoolean(R.styleable.MenuGroup_android_enabled, defaultItemVisible);
            a.recycle();
        }

        public void readItem(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, R.styleable.MenuItem);
            this.itemId = a.getResourceId(R.styleable.MenuItem_android_id, defaultItemOrder);
            this.itemCategoryOrder = (SupportMenu.CATEGORY_MASK & a.getInt(R.styleable.MenuItem_android_menuCategory, this.groupCategory)) | (GameRequest.TYPE_ALL & a.getInt(R.styleable.MenuItem_android_orderInCategory, this.groupOrder));
            ...
            this.itemIconResId = a.getResourceId(R.styleable.MenuItem_android_icon, defaultItemOrder);
            ...
            if (a.hasValue(R.styleable.MenuItem_android_checkable)) {
                int i;
                if (a.getBoolean(R.styleable.MenuItem_android_checkable, defaultItemChecked)) {
                    i = 1;
                } else {
                    i = defaultItemOrder;
                }
            ...
            this.itemActionViewLayout = a.getResourceId(R.styleable.MenuItem_actionLayout, defaultItemOrder);
