...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class 1 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & Connections.MAX_RELIABLE_MESSAGE_LEN) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(R.styleable.Theme_spinnerStyle);
            }
    ...
    class 5 implements Runnable {
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new 1());
        }
    }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(R.styleable.Theme_spinnerStyle, subMenu);
            }
            return true;
        }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class 1 implements ParcelableCompatCreatorCallbacks<SavedState> {
                1() {
                }
    ...
    AppCompatDelegateImplV7(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new 1();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(R.styleable.Theme_spinnerStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(android.support.v7.appcompat.R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionBar, false)) {
                requestWindowFeature(R.styleable.Theme_spinnerStyle);
            }
            if (a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(R.styleable.Theme_switchStyle);
            }
            if (a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            LayoutInflater inflater = LayoutInflater.from(this.mContext);
            ViewGroup subDecor = null;
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(android.support.v7.appcompat.R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(android.support.v7.appcompat.R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new 2());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new 3());
                }
            } else if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(android.support.v7.appcompat.R.layout.abc_dialog_title_material, null);
                ...
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(android.support.v7.appcompat.R.layout.abc_screen_toolbar, null);
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(R.styleable.Theme_switchStyle);
                }
            ...
            ContentFrameLayout abcContent = (ContentFrameLayout) subDecor.findViewById(android.support.v7.appcompat.R.id.action_bar_activity_content);
            ...
            abcContent.setAttachListener(new 4());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(android.support.v7.appcompat.R.styleable.Theme);
        a.getValue(android.support.v7.appcompat.R.styleable.Theme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(android.support.v7.appcompat.R.styleable.Theme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == R.styleable.Theme_spinnerStyle) {
            return false;
        }
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == R.styleable.Theme_spinnerStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, null, android.support.v7.appcompat.R.attr.actionModePopupWindowStyle);
                    ...
                    this.mShowActionModePopup = new 5();
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new 6());
                    if (this.mActionModePopup != null) {
    ...
    boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            case Yytoken.TYPE_RIGHT_SQUARE /*4*/:
                if ((event.getFlags() & RadialCountdown.BACKGROUND_ALPHA) == 0) {
                    z = false;
                }
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp2 = new WindowManager.LayoutParams(width, -2, st.x, st.y, AdError.LOAD_TOO_FREQUENTLY_ERROR_CODE, 8519680, -3);
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(R.styleable.Theme_spinnerStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(R.styleable.Theme_spinnerStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == R.styleable.Theme_spinnerStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == R.styleable.Theme_spinnerStyle) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(R.styleable.Theme_spinnerStyle, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == R.styleable.Theme_spinnerStyle || featureId == 0) && this.mDecorContentParent != null) {
