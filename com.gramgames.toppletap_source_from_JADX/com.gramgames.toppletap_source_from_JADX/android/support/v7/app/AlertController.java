...
class AlertController {
    ...
    public static class AlertParams {
        ...
        class 1 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            1(Context x0, int x1, int x2, CharSequence[] x3, ListView listView) {
        ...
        class 2 extends CursorAdapter {
            ...
            2(Context x0, Cursor x1, boolean x2, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class 4 implements OnItemClickListener {
            ...
            4(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                ListAdapter 2 = new 2(this.mContext, this.mCursor, false, listView, dialog);
            }
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                ...
                this.mListView.setOnScrollListener(new 4(top, bottom));
