...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            switch (((ActivityChooserViewAdapter) parent.getAdapter()).getItemViewType(position)) {
                ...
                case Yytoken.TYPE_LEFT_BRACE /*1*/:
                    ActivityChooserView.this.showPopupUnchecked(MoPubClientPositioning.NO_REPEAT);
                default:
                    throw new IllegalArgumentException();
            }
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new 1();
        ...
        expandButton.setOnTouchListener(new 3(expandButton));
        ...
        this.mAdapter.registerDataSetObserver(new 4());
    ...
    private void showPopupUnchecked(int maxActivityCount) {
        ...
        if (maxActivityCount == MoPubClientPositioning.NO_REPEAT || activityCount <= maxActivityCount + maxActivityCountOffset) {
