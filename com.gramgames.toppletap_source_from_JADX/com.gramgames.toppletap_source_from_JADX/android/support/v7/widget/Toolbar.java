...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int contentInsetStart = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetStart, Cue.TYPE_UNSET);
        int contentInsetEnd = a.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEnd, Cue.TYPE_UNSET);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        i = widthMeasureSpec;
        int measuredWidth = ViewCompat.resolveSizeAndState(Math.max(width + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, CtaButton.BACKGROUND_COLOR & childState);
        i = heightMeasureSpec;
