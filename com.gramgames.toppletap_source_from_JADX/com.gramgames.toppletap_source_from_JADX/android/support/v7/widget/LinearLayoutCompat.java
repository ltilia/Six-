...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mWeightSum = a.getFloat(R.styleable.LinearLayoutCompat_android_weightSum, PlayerStats.UNSET_VALUE);
                ...
                if (majorGravity != 48) {
                    switch (majorGravity) {
                        case com.unity3d.ads.android.R.styleable.Toolbar_titleMarginBottom /*16*/:
                            ...
                            break;
                        case com.unity3d.ads.android.R.styleable.Theme_panelMenuListTheme /*80*/:
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int largestChildHeight = Cue.TYPE_UNSET;
        int i = SHOW_DIVIDER_NONE;
        while (i < count) {
            int childHeight;
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int largestChildWidth = Cue.TYPE_UNSET;
            ...
            for (i2 = SHOW_DIVIDER_NONE; i2 < count; i2 += VERTICAL) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        childState = ViewUtils.combineMeasuredStates(childState, ViewCompat.getMeasuredState(child) & CtaButton.BACKGROUND_COLOR);
                    }
                    if (isExactly) {
        ...
        setMeasuredDimension((CtaButton.BACKGROUND_COLOR & childState) | widthSizeAndState, ViewCompat.resolveSizeAndState(Math.max(maxHeight + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), heightMeasureSpec, childState << 16));
        if (matchHeight) {
            ...
            if (child == null) {
                ...
                switch (gravity & 112) {
                    case com.unity3d.ads.android.R.styleable.Toolbar_titleMarginBottom /*16*/:
                        ...
                        break;
                    case com.unity3d.ads.android.R.styleable.Theme_homeAsUpIndicator /*48*/:
