...
public class ListPopupWindow {
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mListItemExpandMaximum = MoPubClientPositioning.NO_REPEAT;
        ...
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            int firstItem = MoPubClientPositioning.NO_REPEAT;
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case com.unity3d.ads.android.R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case UnityAdsProperties.MAX_BUFFERING_WAIT_SECONDS /*20*/:
                        case com.unity3d.ads.android.R.styleable.Toolbar_titleTextColor /*23*/:
                        case com.unity3d.ads.android.R.styleable.Theme_textAppearanceSearchResultSubtitle /*66*/:
                            return true;
                    }
