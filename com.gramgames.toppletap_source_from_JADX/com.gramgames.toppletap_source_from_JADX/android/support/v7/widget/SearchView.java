...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new 1();
        this.mUpdateDrawableStateRunnable = new 2();
        this.mReleaseCursorRunnable = new 3();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new 7();
        this.mTextKeyListener = new 8();
        this.mOnEditorActionListener = new 9();
        this.mOnItemClickListener = new 10();
        this.mOnItemSelectedListener = new 11();
        this.mTextWatcher = new 12();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new 4());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new 5());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new 6());
    }
