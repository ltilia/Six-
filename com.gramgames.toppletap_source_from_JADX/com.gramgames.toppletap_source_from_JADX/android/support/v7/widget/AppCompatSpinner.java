...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class 1 extends ForwardingListener {
        ...
        1(View x0, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class 3 implements OnDismissListener {
            ...
            3(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new 2();
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mPopup != null && MeasureSpec.getMode(widthMeasureSpec) == Cue.TYPE_UNSET) {
