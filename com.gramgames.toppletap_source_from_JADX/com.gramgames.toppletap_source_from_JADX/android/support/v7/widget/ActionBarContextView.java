...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(R.id.action_mode_close_button).setOnClickListener(new 1(mode));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            int childSpecHeight = MeasureSpec.makeMeasureSpec(height, Cue.TYPE_UNSET);
            if (this.mClose != null) {
            ...
            if (this.mCustomView != null) {
                ...
                int i = lp2.width;
                int customWidthMode = r0 != -2 ? 1073741824 : Cue.TYPE_UNSET;
                if (lp2.width >= 0) {
                ...
                i = lp2.height;
                int customHeightMode = r0 != -2 ? 1073741824 : Cue.TYPE_UNSET;
                if (lp2.height >= 0) {
