...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f).setDuration(duration).setListener(new 2(visibility));
    }
