...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName component) {
        ...
        try {
            ActivityInfo activityInfo = pm.getActivityInfo(component, RadialCountdown.BACKGROUND_ALPHA);
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Builder uriBuilder = new Builder().scheme(AppLovinEventTypes.USER_VIEWED_CONTENT).authority(authority).query(BuildConfig.FLAVOR).fragment(BuildConfig.FLAVOR);
